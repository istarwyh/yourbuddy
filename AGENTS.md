...
docs/        Architecture, user guides, references, postmortems, and releases
website/     VitePress SDK and OINK product projections of canonical docs/ sources
.agents/     Agent workflows, reusable skills, and Agent Notes
.github/     CI, release, issue-management, and repository automation
```

[`packages/README.md`](packages/README.md) is the authoritative package-group map; do not duplicate its group inventory here.
...
pnpm run website:build  # documentation website build and link checks
