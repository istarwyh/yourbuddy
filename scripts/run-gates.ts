...
function desktopShellPermissionsGate(): Gate {
  return pnpmScript('desktop-shell-permissions', 'verify-desktop-shell-permissions', {
    label: 'desktop shell permissions',
  })
}
...
function docSyncLeafGates(options: {
  ...
  return [
    ...
    pnpmScript('package-group-map', 'verify-package-group-map', { label: 'package group map', quick: true }),
    ...
    pnpmExec('docs-site-projection', [
      'vitest', 'run', 'scripts/project-doc-site.spec.ts', 'scripts/product-site.spec.ts',
      'scripts/verify-doc-site-fragments.spec.ts', 'website/tests/mermaid-viewer.spec.ts',
      'website/tests/image-viewer.spec.ts', 'website/tests/code-groups.spec.ts',
