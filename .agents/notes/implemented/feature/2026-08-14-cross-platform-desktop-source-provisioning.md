...
[YourBuddy product workbench distribution](2026-08-22-yourbuddy-product-workbench.md) narrows its product release to macOS arm64 and a separate `yourbuddy-updater` channel while retaining this provisioning mechanism.
