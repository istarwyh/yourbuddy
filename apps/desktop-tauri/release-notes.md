...
YourBuddy 0.3.13 makes creator publishing available from the built-in Content Creation preset.
...
YourBuddy 0.3.13 在内置的“内容创作”Preset 中提供创作者发布能力。
...
- [Tagged verification record / Tag 内验证记录](https://github.com/istarwyh/yourbuddy/tree/yourbuddy-v0.3.13/docs/releases/yourbuddy-v0.3.13)
