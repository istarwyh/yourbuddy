...
function isHistoricalJob(value) {
  ...
  return value?.jobKind === HISTORICAL_JOB_KIND || value?.job_kind === HISTORICAL_JOB_KIND || protocols.has("historical-generation-evaluation-context/v1") || protocols.has("historical-generation-evaluation-context/v2");
}
