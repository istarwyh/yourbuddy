...
function rawHarborReferenceRanges(value2, occurrences = [], token) {
  const draft = String(value2 ?? "");
...
function hasHarborReference(value2, occurrences = [], token) {
  if (!token) return false;
  if ((Array.isArray(occurrences) ? occurrences : []).some((item) => item?.source === "harbor" && item.ref === token)) return true;
  return rawHarborReferenceRanges(value2, occurrences, token).length > 0;
}
...
var HISTORICAL_MESSAGES = {
  zh: {
    historicalLaunch: "\u4F53\u9A8C\u8BCA\u65AD\uFF1A\u8BC4\u6D4B\u6700\u8FD1\u4F1A\u8BDD",
    historicalLaunchShort: "\u5F00\u59CB\u4F53\u9A8C\u8BCA\u65AD",
    historicalLaunchHint: "\u6700\u591A 3 \u6761 \xB7 \u786E\u8BA4\u540E\u5F00\u59CB",
    historicalLaunchBody: "\u7528\u5185\u7F6E\u4F53\u9A8C\u8BC4\u6D4B\u5668\u5206\u6790\u6700\u8FD1\u5DF2\u5B8C\u6210\u7684\u4F1A\u8BDD\uFF0C\u4E86\u89E3 Harbor \u5982\u4F55\u533A\u5206\u8D28\u91CF\u3001\u8BC1\u636E\u4E0D\u8DB3\u548C\u8BC4\u6D4B\u6545\u969C\uFF1B\u7ED3\u679C\u4E0D\u662F\u6B63\u5F0F\u4E1A\u52A1\u8D28\u91CF\u8BC1\u660E\u3002",
    historicalPreparing: "\u6B63\u5728\u67E5\u627E\u6700\u8FD1\u53EF\u4F53\u9A8C\u8BC4\u6D4B\u7684\u4F1A\u8BDD\u2026",
    historicalPreparingShort: "\u8BFB\u53D6\u4E2D\u2026",
    historicalPreviewTitle: "\u7528\u8FD9\u4E9B\u4F1A\u8BDD\u4F53\u9A8C\u8BCA\u65AD\uFF1F",
    historicalPreviewHint: "\u5DF2\u81EA\u52A8\u67E5\u627E DSH \u5386\u53F2\u8BB0\u5F55\u3002\u786E\u8BA4\u524D\u53EA\u8BFB\u53D6\uFF0C\u4E0D\u542F\u52A8\u8BC4\u6D4B\u3002\u5185\u7F6E\u8BC4\u6D4B\u5668\u7528\u4E8E\u6F14\u793A\u7406\u5FF5\uFF0C\u4E0D\u4EE3\u8868\u4F60\u7684\u4E1A\u52A1\u6807\u51C6\u3002",
    ...
    historicalConfirm: "\u786E\u8BA4\u5E76\u5F00\u59CB\u4F53\u9A8C\u8BCA\u65AD",
    historicalStarting: "\u6B63\u5728\u542F\u52A8\u4F53\u9A8C\u8BCA\u65AD\u2026",
    historicalRunning: "\u6B63\u5728\u8BC4\u6D4B\u5386\u53F2\u4F1A\u8BDD\uFF08\u4F53\u9A8C\u8BCA\u65AD\uFF09",
    ...
    historicalBoundaries: "\u4F53\u9A8C\u8BCA\u65AD\u8BF4\u660E",
    historicalBoundaryDetail: "\u53EA\u8BCA\u65AD\u5DF2\u6709\u5BF9\u8BDD\uFF0C\u4E0D\u91CD\u8DD1\u539F\u4EFB\u52A1\uFF0C\u4E0D\u81EA\u52A8\u4FEE\u6539\u3001\u90E8\u7F72\u6216\u664B\u7EA7 Agent\u3002\u5185\u7F6E\u8BC4\u6D4B\u5668\u7528\u4E8E\u4ECB\u7ECD Harbor \u7406\u5FF5\uFF0C\u4E0D\u4EE3\u8868\u6B63\u5F0F\u4E1A\u52A1\u6807\u51C6\uFF0C\u4E5F\u4E0D\u8868\u793A\u8BC4\u6D4B\u5668\u5DF2\u7ECF\u9A8C\u8BC1\u53EF\u9760\u3002",
    feedbackCounts: "\u53CD\u9988",
    turnCounts: "\u8F6E\u6B21",
    toolCounts: "\u5DE5\u5177\u8C03\u7528",
    previewAgain: "\u91CD\u65B0\u67E5\u627E",
  ...
  en: {
    historicalLaunch: "Experience diagnostic: evaluate recent Sessions",
    historicalLaunchShort: "Start experience diagnostic",
    ...
    historicalPreparing: "Finding recent Sessions for the experience diagnostic\u2026",
    historicalPreparingShort: "Loading\u2026",
    historicalPreviewTitle: "Use these Sessions for an experience diagnostic?",
    historicalPreviewHint: "DSH history was found automatically. Nothing is evaluated until you confirm. The built-in Evaluator demonstrates the method; it is not your business standard.",
    ...
    historicalConfirm: "Confirm and start experience diagnostic",
    historicalStarting: "Starting experience diagnostic\u2026",
    historicalRunning: "Evaluating historical Sessions (experience diagnostic)",
    ...
    historicalBoundaries: "About this experience diagnostic",
    historicalBoundaryDetail: "Diagnoses existing conversations only. No task rerun, automatic Agent changes, deployment, or promotion. The built-in Evaluator demonstrates Harbor concepts; it is not a formal business standard and has not been validated for your domain.",
...
function actionDraftDiagnosticSummary(operation) {
  ...
  const inconsistent = counts.trials !== void 0 && [counts.validScores, counts.invalidScores, counts.unscored].some((value2) => value2 !== void 0 && value2 > counts.trials);
  const status = counts.exceptions > 0 ? "exceptions" : counts.validScores === 0 ? "no-valid-scores" : artifactValid === false || inconsistent ? "unverified" : counts.invalidScores > 0 || counts.unscored > 0 || counts.validScores < counts.trials ? "partial" : [counts.trials, counts.validScores, counts.exceptions].some((value2) => value2 === void 0) || artifactValid !== true ? "unverified" : "finished";
...
function actionOperationFailure(operation) {
  ...
  return [code, message].filter((value2) => typeof value2 === "string").join(" \xB7 ").slice(0, 2e3);
}
...
function actionDraftComparison(result) {
  ...
  return {
    ...
    metrics: Object.entries(data.metrics ?? {}).slice(0, 6).map(([name2, value2]) => ({
      name: name2,
      baseline: Number.isFinite(value2?.baseline) ? value2.baseline : void 0,
      candidate: Number.isFinite(value2?.candidate) ? value2.candidate : void 0,
      delta: Number.isFinite(value2?.delta) ? value2.delta : void 0,
      direction: value2?.direction === "minimize" ? "minimize" : "maximize"
    })),
...
var ACTION_CARD_MESSAGES = {
  zh: {
    ...
    actionCleanupRequired: "Host \u8FDB\u7A0B\u5DF2\u505C\u6B62\uFF0C\u4F46\u8FD0\u884C\u65F6\u6E05\u7406\u4ECD\u5F85\u6838\u5BF9\uFF0C\u5DE5\u4F5C\u533A\u8BCA\u65AD\u9501\u7EE7\u7EED\u4FDD\u7559\u3002\u8BF7\u68C0\u67E5\u8FDB\u7A0B\u3001\u8FD0\u884C\u4EA7\u7269\u4E0E\u5360\u7528\u8BB0\u5F55\uFF0C\u5B8C\u6210\u6E05\u7406\u524D\u4E0D\u8981\u518D\u6B21\u542F\u52A8\u8BCA\u65AD\u3002",
  ...
  en: {
    ...
    actionCleanupRequired: "The Host process stopped, but runtime cleanup still requires verification. The workspace diagnostic lock remains held. Inspect and reconcile processes, run artifacts, and the claim before starting another diagnostic.",
...
var format = (value2) => Number.isFinite(value2) ? Number(value2.toFixed(4)).toLocaleString() : "\u2014";
var pretty = (value2) => JSON.stringify(value2, null, 2);
function ActionDraftCardView({ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, request, update, ErrorState, t }) {
  const label = (key) => {
    const value2 = t?.(key);
    return value2 && value2 !== key ? value2 : ACTION_CARD_MESSAGES.zh[key] ?? key;
  };
  ...
  const setState = (next) => {
    ...
    const value2 = typeof next === "function" ? next(live.current.state) : next;
    live.current.state = { ...value2, draftKey };
  ...
  const setReceipt = (value2) => {
    if (live.current.mounted && live.current.draftKey === draftKey) setStoredReceipt({ ...value2, draftKey });
  };
  ...
  const confirm = async () => {
    ...
    try {
      ...
      if (draft.operationId && live.current.mounted && live.current.draftKey === draftKey) {
        setReceipt({ loading: true });
        setReceiptAttempt((value2) => value2 + 1);
      }
    } finally {
      locks.current.delete(lock);
    }
...
function acceptOperationList(value2, sessionId, current = []) {
  if (!Array.isArray(value2?.items)) throw new Error("Invalid operation list; retained states are not current.");
  const seen = /* @__PURE__ */ new Set();
  return value2.items.map((item) => {
...
function pollOperationList({ request, sessionId, limit = 20, getCurrent, onList, onError, schedule = setTimeout, unschedule = clearTimeout }) {
  ...
  const read = async () => {
    ...
    let delay = 5e3;
    try {
      const value2 = await request("action-operations", { limit }, { signal: controller.signal });
      if (!alive) return;
      const items = acceptOperationList(value2, sessionId, getCurrent?.());
      onList({ ...value2, items });
...
for (const locale of ["zh", "en"]) Object.assign(OPERATION_TRAY_MESSAGES[locale], Object.fromEntries(Object.entries(PHASES[locale]).map(([key, value2]) => [`phase_${key}`, value2])));
...
${scopeKey ?? ""}`;
  ...
  (0, import_react2.useEffect)(() => {
    ...
    return pollOperationList({
      ...
      onList: (value2) => {
        if (live.current.ownerKey === ownerKey) setStored({ ...value2, ownerKey, loading: false });
      },
      onError: (error) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("section", { className: "hse-operation-tray", "aria-label": label("tasks") }, /* @__PURE__ */ import_react2.default.createElement("button", { type: "button", className: "hse-operation-toggle", "aria-expanded": expanded, onClick: () => setExpanded((value2) => !value2) }, label("tasks"), " \xB7 ", /* @__PURE__ */ import_react2.default.createElement("span", { role: "status" }, state.loading ? label("loading") : `${active} ${label("active")} \xB7 ${attention} ${label("attention")} \xB7 ${state.items.length} ${label("records")}`), expanded ? " \u2212" : " +"), state.error ? /* @__PURE__ */ import_react2.default.createElement("p", { role: "alert" }, label("stale"), /* @__PURE__ */ import_react2.default.createElement("button", { type: "button", onClick: () => setAttempt((value2) => value2 + 1) }, label("refresh"))) : null, expanded ? /* @__PURE__ */ import_react2.default.createElement("div", { className: "hse-operation-list" }, /* @__PURE__ */ import_react2.default.createElement("p", null, label("taskHint")), !state.loading && !state.items.length && !state.error ? /* @__PURE__ */ import_react2.default.createElement("p", null, label("empty")) : null, state.items.map((operation) => /* @__PURE__ */ import_react2.default.createElement(OperationItem, { key: `${ownerKey}:${operation.operationId}`, ...{ operation, request, update, onViewResult, label }, stale: Boolean(state.error), onChanged: () => setAttempt((value2) => value2 + 1) })), state.nextCursor && limit < 100 ? /* @__PURE__ */ import_react2.default.createElement("button", { type: "button", onClick: () => setLimit((value2) => Math.min(100, value2 + 20)) }, label("loadMore")) : state.truncated || state.nextCursor ? /* @__PURE__ */ import_react2.default.createElement("p", null, label("more")) : null) : null);
}
function OperationItem({ operation, request, update, onViewResult, onChanged, label, stale }) {
  ...
  const inspect = () => run("inspect", async () => {
    const value2 = await request("action-inspect", { operationId: operation.operationId });
    if (value2?.operationId !== operation.operationId) throw new Error("Inspection identity mismatch");
    if (mounted.current) {
      setInspection(value2);
      setReviewed(false);
    }
  });
  const release = () => {
...
function scopeValue(value2, name2) {
  if (typeof value2 !== "string" || !value2.trim() || value2.length > 2048 || /[\u0000-\u001f]/.test(value2)) {
...
function validContent(value2) {
  return Boolean(value2 && typeof value2 === "object" && !Array.isArray(value2) && typeof value2.baseDigest === "string" && value2.baseDigest.length > 0 && value2.baseDigest.length <= 1024 && typeof value2.baseText === "string" && value2.baseText.length <= MAX_TEXT_LENGTH && typeof value2.text === "string" && value2.text.length <= MAX_TEXT_LENGTH);
}
...
function createEditorDraftStore({ storage, now = Date.now, maxEntries = 32 } = {}) {
  ...
  function persist() {
    ...
    try {
      if (!drafts.size) adapter.removeItem(STORAGE_KEY);
        ...
        const serialized = JSON.stringify({ schema: SCHEMA, entries: [...drafts].map(([key, value2]) => ({ key, ...value2 })) });
  ...
  return {
    list(scope) {
      ...
      return [...drafts].flatMap(([key, value2]) => {
        const parts = JSON.parse(key);
        return prefix.every((part, index) => part === parts[index]) ? [{ key, role: parts[3], path: parts[4], ...copy(value2) }] : [];
      });
    },
    get(key) {
      assertKey(key);
    ...
    put(key, value2) {
      assertKey(key);
      if (!validContent(value2)) return { draft: copy(drafts.get(key)), accepted: false, persisted: false, error: failure("HARBOR_EDITOR_DRAFT_TOO_LARGE", "This draft cannot be stored: source identity must be present and each source buffer must be at most 256 Ki characters. Keep the visible edits or copy them before leaving.") };
      ...
      const draft = {
        baseDigest: previous?.baseDigest ?? value2.baseDigest,
        baseText: previous?.baseText ?? value2.baseText,
        text: value2.text,
        updatedAt
      };
      drafts.set(key, draft);
      return { draft: copy(draft), accepted: true, baseChanged: Boolean(previous && (previous.baseDigest !== value2.baseDigest || previous.baseText !== value2.baseText)), ...persist() };
    },
    remove(key) {
      assertKey(key);
      drafts.delete(key);
...
function editorBuffers() {
  ...
  buffers = {
    ...
    list(scope) {
      ...
      for (const [key, value2] of volatile) {
        const [sessionId, workspace, jobId, role, path] = JSON.parse(key);
        if (sessionId === scope.sessionId && workspace === scope.workspace && jobId === scope.jobId) entries.set(key, { key, role, path, ...value2 });
      }
...
function matchEvaluatorProposalFile(value2, proposal) {
  const source = proposal?.proposal ?? proposal;
  if (value2?.job && source?.sourceRef?.job !== value2.job) return void 0;
  const role = source?.sourceRef?.sourceRole;
  const fileRole = role === "evaluator" ? "implementation" : role === "rubric" ? "rubric" : void 0;
  const component = value2?.components?.[role];
  const savedText = component?.source?.text;
  if (!fileRole || typeof savedText !== "string") return void 0;
  const candidates = (value2?.evaluatorInterface?.evaluator?.editable_files ?? []).filter((file) => file.role === fileRole && file.text === savedText);
  if (candidates.length === 1) return candidates[0];
  const entry = role === "evaluator" ? value2?.evaluatorInterface?.evaluator?.implementation?.path : component?.entry;
...
function prepareEvaluatorProposal({ value: value2, proposal, file, text, record, currentBinding, applySourceProposal: applySourceProposal2 }) {
  const source = proposal?.proposal;
  const proposedFile = matchEvaluatorProposalFile(value2, proposal);
  const sourceRef = value2?.interactionObjects?.find((ref) => ref.id === source?.sourceRef?.id);
...
function EvaluatorEditorView({ value: value2, workspace, job, sessionId, bindingKey, bindingIsCurrent, reload, onSaved, proposal, update, ErrorState, t, applySourceProposal: applySourceProposal2, nextVersion: nextVersion2 }) {
  const active = value2.evaluatorInterface;
  ...
  function loadProposal() {
    ...
    const prepared = prepareEvaluatorProposal({ value: value2, proposal, file: selected, text: draft, record, currentBinding, applySourceProposal: applySourceProposal2 });
...
${entry.path}`)) {
        ...
        setRecoveryRevision((value3) => value3 + 1);
      }
...
function relativePath(value2) {
  if (typeof value2 !== "string" || !value2 || value2.length > 1024 || /[\u0000-\u001f\u007f\\]/.test(value2) || value2.startsWith("/") || /^[a-z][a-z\d+.-]*:/i.test(value2)) return void 0;
  if (value2.split("/").some((part) => !part || part === "." || part === "..")) return void 0;
  return value2;
}
function identity(value2) {
  return typeof value2 === "string" && IDENTITY.test(value2) ? value2 : void 0;
}
function savedEvaluatorReference(receipt, historicalJob) {
  ...
  if (!reference.historicalJob || Object.values(reference.stack).some((value2) => !value2) || Object.values(reference.evaluator).some((value2) => !value2)) return void 0;
  return reference;
}
...
// src/client/evaluation-result.jsx
var import_react5 = __toESM(require("react"), 1);
var EVALUATION_RESULT_MESSAGES = {
  zh: {
    ...
    evaluationErrors: "\u8BC4\u6D4B\u5668\u9519\u8BEF",
    infrastructureErrors: "\u57FA\u7840\u8BBE\u65BD\u5F02\u5E38",
    overallScore: "\u603B\u4F53\u8BC4\u5206",
    noOverallScore: "\u65E0\u6CD5\u8BC4\u5206",
    qualityTriad: "\u7ED3\u679C\u7531\u4E09\u90E8\u5206\u7EC4\u6210",
    generatorQuality: "\u751F\u6210\u5668\u8D28\u91CF",
    evaluationHealth: "\u8BC4\u6D4B\u5065\u5EB7",
    runHealth: "\u8FD0\u884C\u5065\u5EB7",
    status_measured: "\u5DF2\u53EF\u9760\u6D4B\u91CF",
    status_experience_only: "\u4EC5\u4F5C\u4F53\u9A8C\u89C2\u5BDF",
    status_untrusted: "\u6709\u4FE1\u53F7\u4F46\u4E0D\u53EF\u4F5C\u4E3A\u53EF\u9760\u5206\u6570",
    status_insufficient_evidence: "\u8BC1\u636E\u4E0D\u8DB3",
    status_healthy: "\u5065\u5EB7",
    status_limited: "\u5B58\u5728\u9650\u5236",
    status_failed: "\u5931\u8D25",
    ...
    direction_minimize: "\u8D8A\u4F4E\u8D8A\u597D",
    "completed-unscored": "\u5DF2\u5B8C\u6210\uFF0C\u8BC1\u636E\u4E0D\u8DB3\u65E0\u6CD5\u8BC4\u5206"
  },
  en: {
    ...
    qualityTriad: "Read the result in three parts",
    generatorQuality: "Generator quality",
    evaluationHealth: "Evaluation health",
    runHealth: "Run health",
    status_measured: "Reliably measured",
    status_experience_only: "Experience observation only",
    status_untrusted: "Signals exist but are not a trusted score",
    ...
    direction_minimize: "lower is better",
    "completed-unscored": "Completed, insufficient evidence to score"
  }
};
...
function EvaluationResult({ report, openSection, t }) {
  ...
  return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section hse-job-summary", "data-evaluation-verdict": report.verdict?.code }, report.run?.experience_diagnostic ? /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react5.default.createElement("b", null, t("experienceDiagnosticBadge")), /* @__PURE__ */ import_react5.default.createElement("br", null), t("experienceDiagnosticNotice")) : null, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-summary-status" }, /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("span", null, t("evaluationConclusion")), /* @__PURE__ */ import_react5.default.createElement("h3", null, t(verdictKey)), /* @__PURE__ */ import_react5.default.createElement("p", null, report.verdict?.summary))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("validTrialScores")), /* @__PURE__ */ import_react5.default.createElement("b", null, report.sample?.scored ?? 0, "/", report.sample?.total ?? 0)), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("criterionCoverage")), /* @__PURE__ */ import_react5.default.createElement("b", null, percent(report.sample?.criterion_coverage))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("evaluationErrors")), /* @__PURE__ */ import_react5.default.createElement("b", null, report.sample?.evaluation_errors ?? 0)), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("overallScore")), /* @__PURE__ */ import_react5.default.createElement("b", null, report.quality?.overall_score === null ? t("noOverallScore") : value(report.quality?.overall_score))))), /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section", "data-quality-triad": "true" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("qualityTriad")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("generatorQuality")), /* @__PURE__ */ import_react5.default.createElement("b", null, translatedStatus(report.generator_quality?.status, t)), /* @__PURE__ */ import_react5.default.createElement("code", null, report.generator_quality?.overall_score === null ? t("noOverallScore") : value(report.generator_quality?.overall_score))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("evaluationHealth")), /* @__PURE__ */ import_react5.default.createElement("b", null, translatedStatus(report.evaluation_health?.status, t)), /* @__PURE__ */ import_react5.default.createElement("code", null, t("criterionCoverage"), ": ", percent(report.sample?.criterion_coverage))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("runHealth")), /* @__PURE__ */ import_react5.default.createElement("b", null, translatedStatus(report.run_health?.status, t)), /* @__PURE__ */ import_react5.default.createElement("code", null, t("infrastructureErrors"), ": ", report.run_health?.infrastructure_errors ?? 0)))), business ? /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section", "data-business-results-status": business.status }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("realBusinessResults")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react5.default.createElement("b", null, business.association_label), /* @__PURE__ */ import_react5.default.createElement("br", null), t("correlationOnly")), businessObservations.length ? /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-cards" }, businessObservations.slice(0, 5).map((observation) => /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card", key: observation.observation_id }, /* @__PURE__ */ import_react5.default.createElement("span", null, observation.source?.id ?? "\u2014", " \xB7 ", observation.source?.version ?? "\u2014"), /* @__PURE__ */ import_react5.default.createElement("b", null, observation.metrics?.map((metric) => `${metric.id}: ${value(metric.value)} ${metric.unit}`).join(" \xB7 ")), /* @__PURE__ */ import_react5.default.createElement("code", null, t("observationWindow"), ": ", observation.window?.from, " \u2192 ", observation.window?.through), /* @__PURE__ */ import_react5.default.createElement("code", null, observation.metrics?.map((metric) => `${t("sampleSize")} ${metric.sample_size} \xB7 ${t(`direction_${metric.direction}`)}`).join(" \xB7 "))))) : /* @__PURE__ */ import_react5.default.createElement("p", { className: "hse-muted" }, t("noBusinessResults"))) : null, /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("effectiveEvaluator")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-components" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-component" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("effectiveEvaluator")), /* @__PURE__ */ import_react5.default.createElement("b", null, evaluator?.id ?? "\u2014", evaluator?.version ? ` \xB7 ${evaluator.version}` : ""), /* @__PURE__ */ import_react5.default.createElement("code", null, evaluatorStatus(report, t)))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("evaluatorReliability")), /* @__PURE__ */ import_react5.default.createElement("b", null, report.evaluator_reliability?.status === "unvalidated" ? t("unvalidated") : report.evaluator_reliability?.status ?? "\u2014")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react5.default.createElement("span", null, t("datasetValidity")), /* @__PURE__ */ import_react5.default.createElement("b", null, report.dataset_validity?.status === "not-assessed" ? t("notAssessed") : report.dataset_validity?.status ?? "\u2014")))), partialSignals.length ? /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("partialSignals")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-summary-metrics" }, partialSignals.map((item) => /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-summary-metric", key: item.id }, /* @__PURE__ */ import_react5.default.createElement("span", null, item.label ?? item.id), /* @__PURE__ */ import_react5.default.createElement("strong", null, value(item.mean)), /* @__PURE__ */ import_react5.default.createElement("code", null, item.scored, "/", item.scored + item.unscored))))) : null, findings.length ? /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("findings")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-cards" }, findings.slice(0, 5).map((item) => /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card", key: item.id }, /* @__PURE__ */ import_react5.default.createElement("span", null, item.owner, " \xB7 ", item.affected_count), /* @__PURE__ */ import_react5.default.createElement("b", null, item.summary ?? item.root_cause), item.recommendation ? /* @__PURE__ */ import_react5.default.createElement("code", null, item.recommendation) : null)))) : null, cases.length ? /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-section-title" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("casesAndEvidence")), /* @__PURE__ */ import_react5.default.createElement("button", { type: "button", className: "hse-button", onClick: () => openSection?.("trials") }, t("openTasks"))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-cards" }, cases.slice(0, 5).map((item) => /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-card", key: item.trial_id }, /* @__PURE__ */ import_react5.default.createElement("span", null, item.status ? t(item.status) : "\u2014"), /* @__PURE__ */ import_react5.default.createElement("b", null, item.trial_id), /* @__PURE__ */ import_react5.default.createElement("code", null, item.score_valid ? value(item.score) : t("noOverallScore")))))) : null, report.next_action ? /* @__PURE__ */ import_react5.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react5.default.createElement("h3", null, t("nextAction")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "hse-hook-state", "data-executed": "false" }, /* @__PURE__ */ import_react5.default.createElement("b", null, report.next_action.change), /* @__PURE__ */ import_react5.default.createElement("br", null), /* @__PURE__ */ import_react5.default.createElement("span", null, t("actionOwner"), ": ", report.next_action.owner), report.next_action.verification ? /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("br", null), /* @__PURE__ */ import_react5.default.createElement("code", null, report.next_action.verification)) : null)) : null);
}

// src/client/product-modes.js
var ALL_PIPELINE_STAGES = ["candidate", "dataset", "integration", "renderer", "judge", "meta", "reporter", "optimizer", "gate"];
function deriveArtifactProfile({ historical = false, context, registry, job } = {}) {
  if (historical) return "diagnostic";
  const profile = context?.artifact_profile ?? registry?.artifact_profile ?? job?.artifactProfile ?? job?.evaluationType ?? (job?.mode === "promotion-eligible" ? "governed" : "experiment");
  return ["diagnostic", "experiment", "governed"].includes(profile) ? profile : "experiment";
}
function sectionsForArtifactProfile(profile, { historical = false } = {}) {
  ...
  return {
    ...
    advanced: profile === "governed" ? ["pipeline", "artifacts", "audit"] : profile === "experiment" ? ["pipeline", "artifacts"] : ["pipeline"]
  };
}
function pipelineStagesForArtifactProfile(profile) {
  return profile === "governed" ? [...ALL_PIPELINE_STAGES] : ALL_PIPELINE_STAGES.filter((stage) => stage !== "gate");
}

// src/client/trial-selection-state.js
function trialSelectionMemberIds(value2, ref = value2?.ref) {
  const members = value2?.members;
  if (!ref || value2?.ref?.id !== ref.id || value2.ref.sourceDigest !== ref.sourceDigest || value2.ref.job !== ref.job || value2.ref.selectionCount !== ref.selectionCount || !Array.isArray(members) || members.length < 1 || members.length > 1e3 || members.length !== value2.count || members.length !== ref.selectionCount) {
...
var dictionaries = {
  zh: {
    ...
    jobSection_summary: "\u7ED3\u8BBA",
    jobSection_trials: "\u4EFB\u52A1\u4E0E\u8BC1\u636E",
    jobSection_pipeline: "\u6267\u884C\u6D41\u7A0B",
    jobSection_optimization: "\u6539\u8FDB\u5EFA\u8BAE",
    jobSection_compare: "\u7248\u672C\u6BD4\u8F83",
    jobSection_evaluator: "\u8BC4\u6D4B\u5668",
    jobSection_artifacts: "\u539F\u59CB\u4EA7\u7269",
    jobSection_audit: "\u5BA1\u8BA1\u4FE1\u606F",
    advancedDetails: "\u5B9E\u9A8C\u8BE6\u60C5 / \u9AD8\u7EA7\u4FE1\u606F",
    ...
    evaluatorEditExecuted: "\u5F53\u524D\u7F16\u8F91\u5668\u7ED1\u5B9A\u5230\u672C\u6B21 Job \u5DF2\u9A8C\u8BC1\u3001\u5B9E\u9645\u6267\u884C\u7684\u8BC4\u6D4B\u5668\u3002\u4FDD\u5B58\u4F1A\u521B\u5EFA\u65B0\u7684\u8BC4\u6D4B\u5668\u4E0E Stack \u7248\u672C\u3002",
    evaluatorForkExecuted: "\u5F53\u524D\u7F16\u8F91\u5668\u6765\u81EA\u672C\u6B21 Job \u7684\u4E0D\u53EF\u53D8\u6267\u884C\u5FEB\u7167\u3002\u4FDD\u5B58\u4F1A\u4ECE\u8BE5\u5FEB\u7167\u5206\u53C9\u65B0\u7248\u672C\uFF0C\u4E0D\u4F1A\u6539\u5199\u5F53\u524D\u6216\u5386\u53F2\u7248\u672C\u3002",
    ...
    tab: "Harbor",
    settings: "Harbor \u81EA\u8FDB\u5316",
    heroTitle: "\u7A33\u4F4F Agent \u7684\u6BCF\u4E00\u6B21\u8FDB\u6B65",
    heroBody: "Harbor \u56FA\u5B9A\u5B9E\u9A8C\u8FB9\u754C\uFF1BTrial Lifecycle \u5C55\u793A\u771F\u5B9E\u8FD0\u884C\u8FC7\u7A0B\uFF1BScore Validity \u963B\u6B62\u57FA\u7840\u8BBE\u65BD\u6545\u969C\u4F2A\u88C5\u6210\u4E1A\u52A1 0 \u5206\u3002",
    refresh: "\u5237\u65B0",
    jobs: "\u8BC4\u6D4B\u6279\u6B21",
    jobsHint: "\u70B9\u51FB Job \u540E\uFF0C\u6700\u591A\u518D\u70B9\u4E00\u6B21\u5373\u53EF\u8FDB\u5165\u5BF9\u5E94 Trial \u7684\u8BC1\u636E\u3002",
    formalExperiment: "\u6B63\u5F0F\u4E1A\u52A1\u5B9E\u9A8C",
    formalExperimentHint: "\u4F7F\u7528\u56FA\u5B9A\u8BC4\u6D4B\u96C6\u3001\u4F60\u7684\u751F\u6210\u5668\u548C\u4F60\u63D0\u4F9B\u7684 Evaluator\uFF0C\u5EFA\u7ACB\u53EF\u590D\u73B0\u7684 Baseline/Candidate \u6BD4\u8F83\u3002\u666E\u901A\u5B9E\u9A8C\u4E0D\u4F1A\u8FD0\u884C Gate\uFF1B\u53EA\u6709\u663E\u5F0F\u9009\u62E9\u6CBB\u7406\u6A21\u5F0F\u624D\u4F1A\u8FDB\u5165\u664B\u7EA7\u5224\u65AD\u3002",
    formalExperimentFlow: "\u8BC4\u6D4B\u96C6 \u2192 \u751F\u6210\u5668 \u2192 \u5B9E\u9645\u6267\u884C\u7684\u8BC4\u6D4B\u5668 \u2192 \u6307\u6807 \u2192 \u4E00\u4E2A\u53EF\u9A8C\u8BC1\u7684\u6539\u8FDB",
    planFormalExperiment: "\u89C4\u5212\u6B63\u5F0F\u5B9E\u9A8C",
    formalExperimentPrompt: "\u8BF7\u4F7F\u7528 evolve-agent-with-harbor \u5E2E\u6211\u89C4\u5212\u4E00\u4E2A\u6B63\u5F0F\u4E1A\u52A1 Experiment\u3002\u5148\u786E\u8BA4\u56FA\u5B9A Dataset\u3001Candidate Generator\u3001\u7528\u6237\u63D0\u4F9B\u7684 Evaluator v2\u3001\u4E3B\u6307\u6807\u548C repeat policy\uFF0C\u518D\u9884\u89C8 experiment \u6A21\u5F0F\u7684 Evaluation Context\u3002\u4E0D\u8981\u8FD0\u884C\u8BC4\u6D4B\u3001Gate \u6216\u4FEE\u6539\u6587\u4EF6\uFF0C\u76F4\u5230\u6211\u786E\u8BA4\u3002",
    workspace: "\u5DE5\u4F5C\u7A7A\u95F4",
    ...
    running: "\u8FD0\u884C\u4E2D",
    "completed-unscored": "\u5DF2\u5B8C\u6210\uFF0C\u8BC1\u636E\u4E0D\u8DB3\u65E0\u6CD5\u8BC4\u5206",
    "candidate-quality-failed": "\u5019\u9009\u8D28\u91CF\u672A\u8FBE\u6807",
    "infrastructure-error": "\u57FA\u7840\u8BBE\u65BD\u5F02\u5E38",
    "evaluation-error": "\u8BC4\u6D4B\u5668\u5F02\u5E38",
    "running-agent": "\u751F\u6210\u5668\u8FD0\u884C\u4E2D",
    evaluating: "\u8BC4\u6D4B\u4E2D",
    unknown: "\u72B6\u6001\u672A\u77E5",
    scored: "\u5DF2\u8BC4\u5206",
    unscored: "\u672A\u8BC4\u5206",
    ...
    currentVersion: "\u5F53\u524D\u7248\u672C",
    latestVersion: "\u6700\u65B0\u7248\u672C",
    updateHint: "\u8BF7\u68C0\u67E5\u5E76\u590D\u5236\u7CBE\u786E\u66F4\u65B0\u547D\u4EE4\uFF1B\u547D\u4EE4\u4F1A\u4FDD\u7559 profile\u3001DSH_HOME\u3001Jobs\u3001\u8FD0\u884C\u73AF\u5883\u4E0E\u6258\u7BA1 Python \u76EE\u5F55\uFF0C\u5B8C\u6210\u540E\u9700\u8981\u91CD\u542F YourBuddy\u3002",
    offlineUpdateHint: "\u8FD9\u4E0D\u4F1A\u5F71\u54CD Harbor \u7684\u4EFB\u4F55\u529F\u80FD\u3002\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5\uFF1B\u5B89\u88C5\u8EAB\u4EFD\u4E0D\u5B8C\u6574\u65F6\uFF0C\u8BF7\u5728\u7EC8\u7AEF\u663E\u5F0F\u8FD0\u884C setup \u5E76\u4F20\u5165\u539F\u6709\u914D\u7F6E\u3002",
    ...
    noEvaluatorInterface: "\u5F53\u524D Stack \u8FD8\u6CA1\u6709 harbor-dsh-evaluator/v2 \u63A5\u53E3\uFF0C\u4E0D\u80FD\u4ECE UI \u5B89\u5168\u7F16\u8F91\u3002",
    ...
    upgradeStep4: "\u66F4\u65B0 Evaluation Stack \u8EAB\u4EFD\uFF0C\u5E76\u9884\u89C8 Context v3 \u53D8\u5316\u3002",
  ...
  en: {
    ...
    jobSection_summary: "Result",
    jobSection_trials: "Tasks & evidence",
    jobSection_pipeline: "Execution flow",
    jobSection_optimization: "Improvement",
    jobSection_compare: "Version comparison",
    jobSection_evaluator: "Evaluator",
    jobSection_artifacts: "Raw artifacts",
    jobSection_audit: "Audit details",
    advancedDetails: "Experiment details / Advanced",
    ...
    evaluatorEditExecuted: "This editor is bound to the verified Evaluator that actually ran for this Job. Saving creates new Evaluator and Stack versions.",
    evaluatorForkExecuted: "This editor uses the immutable executed snapshot from this Job. Saving forks a new version without rewriting current or historical versions.",
    ...
    formalExperiment: "Formal business experiment",
    formalExperimentHint: "Use a fixed Dataset, your Generator, and your Evaluator to establish a reproducible Baseline/Candidate comparison. A normal Experiment never runs Gate; promotion is available only in explicit Governed mode.",
    formalExperimentFlow: "Dataset \u2192 Generator \u2192 executed Evaluator \u2192 Metrics \u2192 one verifiable improvement",
    planFormalExperiment: "Plan a formal experiment",
    formalExperimentPrompt: "Use evolve-agent-with-harbor to help me plan a formal business Experiment. First confirm a fixed Dataset, Candidate Generator, user-provided Evaluator v2, primary metric, and repeat policy, then preview an experiment-mode Evaluation Context. Do not run an evaluation, Gate, or modify files until I confirm.",
    workspace: "Workspace",
    ...
    running: "Running",
    "completed-unscored": "Completed, insufficient evidence to score",
    "candidate-quality-failed": "Candidate quality failed",
    "infrastructure-error": "Infrastructure error",
    "evaluation-error": "Evaluator error",
    "running-agent": "Generator running",
    ...
    updateHint: "Review and copy the exact update command. It preserves profile, DSH_HOME, Jobs, execution environment, and managed Python directory. Restart YourBuddy when it finishes.",
    offlineUpdateHint: "Harbor remains fully functional. Check the network and retry. If installation identity is incomplete, run setup in a terminal with the existing options explicitly.",
    ...
    noEvaluatorInterface: "This Stack has no harbor-dsh-evaluator/v2 interface, so safe UI editing is unavailable.",
    ...
    upgradeStep4: "Update the Evaluation Stack identity and preview the Context v3 impact.",
...
for (const locale of ["zh", "en"]) Object.assign(dictionaries[locale], JOURNEY_MESSAGES[locale], ACTION_CARD_MESSAGES[locale], EVALUATOR_EDITOR_MESSAGES[locale], SAVED_EVALUATOR_MESSAGES[locale], EVALUATION_RESULT_MESSAGES[locale], Object.fromEntries(Object.entries(OPERATION_TRAY_MESSAGES[locale]).map(([key, value2]) => [`operationTray_${key}`, value2])));
...
.hse-dashboard-back{margin-bottom:10px}.hse-experiment-onboarding{margin:16px 0;padding:16px;border:1px solid #70cfff55;border-radius:12px;background:var(--dsw-alias-bg-layer-2,#fff);display:flex;align-items:center;justify-content:space-between;gap:18px}.hse-experiment-onboarding h3,.hse-experiment-onboarding p{margin:0 0 6px}.hse-experiment-onboarding code{display:block;white-space:normal;font-size:11px}.hse-experiment-onboarding button{flex:none;padding:9px 12px;border:1px solid #2875ff;border-radius:8px;background:#2875ff;color:#fff;cursor:pointer}@media(max-width:760px){.hse-experiment-onboarding{align-items:stretch;flex-direction:column}}
...
function format2(value2) {
  return typeof value2 === "number" ? value2.toFixed(4).replace(/0+$/, "").replace(/\.$/, "") : String(value2 ?? "\u2014");
}
function short(value2) {
  return typeof value2 === "string" && value2.length > 25 ? `${value2.slice(0, 17)}\u2026${value2.slice(-6)}` : value2 ?? "\u2014";
}
function pretty2(value2) {
  return JSON.stringify(value2, null, 2);
}
function gateReasonText(value2) {
  if (!isRecord(value2)) return String(value2 ?? "\u2014");
  return [value2.code, value2.message].filter(Boolean).join(" \xB7 ") || pretty2(value2);
}
var HISTORICAL_JOB_KIND = "historical-generation-evaluation";
function isHistoricalJob(value2) {
  const protocols = /* @__PURE__ */ new Set([
    value2?.artifacts?.context?.protocol,
    value2?.evaluationContext?.protocol
  ]);
  return value2?.jobKind === HISTORICAL_JOB_KIND || value2?.job_kind === HISTORICAL_JOB_KIND || protocols.has("historical-generation-evaluation-context/v1") || protocols.has("historical-generation-evaluation-context/v2") || protocols.has("historical-generation-evaluation-context/v3");
}
...
function normalizeHarborUiError(value2, observedAt = (/* @__PURE__ */ new Date()).toISOString()) {
  const source = isRecord(value2) ? value2 : {};
  const message = typeof source.message === "string" && source.message ? source.message : typeof value2 === "string" && value2 ? value2 : "Harbor request failed";
...
async function api(route, params = {}, options = {}) {
  const query = new URLSearchParams(Object.entries(params).filter(([, value2]) => value2 !== void 0 && value2 !== ""));
  return requestJson(`${API}/${route}${query.size ? `?${query}` : ""}`, { credentials: "same-origin", cache: "no-store", signal: options.signal });
}
async function mutate(route, value2, options = {}) {
...
var HarborSessionContext = (0, import_react6.createContext)(void 0);
function useHarborApi() {
  const sessionId = (0, import_react6.useContext)(HarborSessionContext);
  if (!sessionId) throw new Error("Harbor workspace requests require a DSH Session");
  return (0, import_react6.useCallback)((route, params = {}, options) => api(route, { ...params, sessionId }, options), [sessionId]);
}
function useHarborMutation() {
  const sessionId = (0, import_react6.useContext)(HarborSessionContext);
  if (!sessionId) throw new Error("Harbor workspace mutations require a DSH Session");
  return (0, import_react6.useCallback)((route, value2 = {}) => mutate(route, { ...value2, sessionId }), [sessionId]);
}
function HarborSkeleton({ kind = "default", rows = 5, label = "Loading" }) {
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-skeleton", "data-kind": kind, role: "status", "aria-label": label, "aria-busy": "true" }, Array.from({ length: rows }, (_, index) => /* @__PURE__ */ import_react6.default.createElement("i", { "aria-hidden": "true", key: index })));
}
...
var HarborUiBridge = class {
  ...
  materializeContext(sessionId, value2) {
    const sessionKey = String(sessionId);
    const pageSessionId = String(value2?.pageSessionId ?? "");
  ...
  setCurrent(sessionId, value2) {
    if (!sessionId || !value2) return void 0;
    const previous = this.getSnapshot(sessionId).current;
    if (contextFingerprint(previous) === contextFingerprint(value2)) return previous;
    const current = this.materializeContext(sessionId, value2);
  ...
  async issue(sessionId, value2, options = {}) {
    if (!sessionId || !value2) throw new Error("No Harbor page context is available");
    options.signal?.throwIfAborted();
    const activate = options.activate !== false;
    const sessionKey = String(sessionId);
    const requested = Object.freeze({ ...value2, schema: "harbor-ui-context/v1", sessionId: sessionKey });
    ...
    if (!pending) {
      ...
      pending = request.then((value3) => Object.freeze({ ...value3, context: value3.context ?? context, fingerprint, oneShot: true })).finally(() => this.inflight.delete(key));
...
function useHarborUi(bridge, sessionId) {
  return (0, import_react6.useSyncExternalStore)(
    (0, import_react6.useCallback)((listener) => bridge.subscribe(sessionId, listener), [bridge, sessionId]),
    (0, import_react6.useCallback)(() => bridge.getSnapshot(sessionId), [bridge, sessionId]),
    () => EMPTY_UI_STATE
  );
}
function createHarborReferenceSource(bridge) {
  return {
    ...
    onPick({ candidate, session }) {
      const value2 = JSON.parse(candidate.value);
      bridge.activateExplicit(session.sessionId, value2);
      return {
        insert: {
          source: "harbor",
          ref: value2.contextSnapshotId,
          label: value2.label,
          clipboardText: value2.reference
        }
      };
    },
    lexicon() {
...
function nextVersion(value2) {
  const match = String(value2 ?? "").match(/^(\d+)\.(\d+)\.(\d+)$/);
...
function workbenchSuccessState(value2, now = Date.now()) {
  return {
    status: "ready",
    value: value2,
...
function useDashboard(poll = true, workspace = "", offset = 0, sessionId, attention = "all") {
  ...
  const requestSequence = (0, import_react6.useRef)(0);
  const pollDelay = (0, import_react6.useRef)(15e3);
  const load = (0, import_react6.useCallback)(async (quiet = false) => {
    const sequence = ++requestSequence.current;
    if (!quiet) setState((current) => ({ ...current, status: current.value ? "refreshing" : "loading" }));
    try {
      const value2 = await api("dashboard", { workspace, offset, limit: 20, sessionId, attention });
      if (sequence === requestSequence.current) setState({ status: "ready", value: value2, consecutiveFailures: 0, lastSuccessAt: Date.now(), stale: false });
    } catch (error) {
...
function identity2(value2, idKey = "id", digestKey = "digest") {
  if (!value2) return void 0;
  const result = {
    id: value2[idKey] ?? value2.id ?? (idKey === "context_id" ? value2.digest : void 0),
    version: value2.version,
    digest: value2[digestKey] ?? value2.digest
  };
  return result.id ? result : void 0;
}
function harborContextFilters(filters) {
  if (!isRecord(filters)) return void 0;
  const result = Object.fromEntries(["status", "validity", "segment"].map((key) => [key, typeof filters[key] === "string" ? filters[key].trim() : ""]).filter(([, value2]) => value2));
...
function toolResultValue(node) {
  ...
  try {
    const value2 = JSON.parse(nodeText(node.content));
    return isRecord(value2) ? value2 : void 0;
  } catch {
    return void 0;
  }
}
...
function trustedHarborToolValue(toolName, value2) {
  const expectedSchema = TRUSTED_HARBOR_UI_ACTION_SCHEMAS[toolName];
  return expectedSchema && value2?.schema === expectedSchema ? value2 : void 0;
}
function trustedHarborUiAction(toolName, value2) {
  const trusted = trustedHarborToolValue(toolName, value2);
  return trusted?.uiAction?.kind === "harbor.navigate" ? trusted.uiAction : void 0;
}
function toolUiAction(nodes) {
  for (const node of [...nodes ?? []].reverse()) {
    const value2 = toolResultValue(node);
    const action = trustedHarborUiAction(node?.call?.name, value2);
...
function trustedHarborReferences(nodes) {
  ...
  for (const node of nodes ?? []) {
    ...
    const value2 = trustedHarborToolValue(toolName, toolResultValue(node));
    const action = value2 ? trustedHarborUiAction(toolName, value2) : void 0;
    if (!action || seen.has(action.actionId)) continue;
    seen.add(action.actionId);
    const evidence = toolName === "harbor_get_evidence" || Array.isArray(value2.selectedEvidence) && value2.selectedEvidence.some((item) => item?.artifactTrust === "untrusted-evidence" && item.available === true && item.ref?.kind !== "trial-set" && item.value !== void 0);
    const ref = toolName === "harbor_get_evidence" ? value2.evidenceRef : value2.refs?.selection?.at(-1) ?? value2.refs?.object;
    const artifactAvailable = evidence ? value2.evidence?.available !== false && value2.evidence?.artifact?.available !== false : true;
    references.push(Object.freeze({
      ...
      label: action.label,
      ref,
      artifactRevision: value2.artifactRevision ?? action.artifactRevision ?? value2.basedOn?.artifactRevision,
...
function harborAnswerBasis(resolved, references = [], fallbackContext) {
  const value2 = resolved?.schema === "harbor-resolved-context/v1" ? resolved : void 0;
  const firstTarget = references.find((item) => item?.action?.target)?.action.target;
  const object = value2?.context?.object ?? value2?.refs?.object ?? fallbackContext?.object;
  const basedOn = value2?.basedOn ?? {};
  ...
  const job = object?.job ?? value2?.context?.route?.params?.job ?? fallbackContext?.route?.params?.job ?? firstTarget?.job;
...
function trustedHarborResolvedContext(nodes) {
  for (const node of [...nodes ?? []].reverse()) {
    ...
    const value2 = trustedHarborToolValue(node.call.name, toolResultValue(node));
...
function ContextFlags({ context, t }) {
  ...
  return values.length ? /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-context-flags" }, values.map((value2) => /* @__PURE__ */ import_react6.default.createElement("em", { key: value2 }, value2))) : null;
}
...
function needsStructuredHarborNormalization(value2, occurrences, explicit, observed = false) {
  ...
  if (observed && !hasHarborReference(value2, occurrences, token)) return false;
  const hasRawReference = rawHarborReferenceRanges(value2, occurrences).length > 0;
...
function HarborInputSync({ bridge, sessionId, useInput, replaceHarborReference }) {
  ...
  const submitted = (0, import_react6.useRef)();
  const observedTokens = (0, import_react6.useRef)(/* @__PURE__ */ new Set());
...
function ActionDraftCard({ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(ActionDraftCardView, { ...{ draft, onSourceDraft, onReprepare, onViewComparison, onViewResult, update, request, t }, ErrorState: HarborErrorState });
}
...
function MetricPills({ metrics }) {
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-metrics" }, Object.entries(metrics ?? {}).map(([key, value2]) => /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-pill", key }, key, /* @__PURE__ */ import_react6.default.createElement("b", null, format2(value2)))));
}
function JobCard({ job, t, open, ask }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("article", { className: "hse-job" }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-job-open", onClick: () => open(job.name) }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-job-body" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-job-top" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-job-title" }, /* @__PURE__ */ import_react6.default.createElement("strong", null, job.name), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-attention-label", "data-kind": attention.kind }, t(`health_${attention.kind}`), attention.count ? ` \xB7 ${attention.count} Trials / conditions` : ""), /* @__PURE__ */ import_react6.default.createElement("small", null, new Date(job.updatedAt).toLocaleString(), " \xB7 ", progress.health ? t(progress.health) : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-status", "data-status": job.status }, t(job.status))), historical ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("historicalTarget")), /* @__PURE__ */ import_react6.default.createElement("b", null, target.source_kind ?? job.generationSource?.kind ?? "\u2014", " \xB7 ", target.record_count ?? job.nTrials ?? 0, " ", t("generationRecords"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("generatorPopulation")), /* @__PURE__ */ import_react6.default.createElement("b", null, generatorPopulationText(job.generatorPopulation ?? target.generator_population, t))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("executionMode")), /* @__PURE__ */ import_react6.default.createElement("b", null, job.executionMode ?? t("observationMode"), " \xB7 ", t("gateNotApplicable"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("progress")), /* @__PURE__ */ import_react6.default.createElement("b", null, progress.completed ?? 0, "/", progress.total ?? job.nTrials ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("scoredTrials")), /* @__PURE__ */ import_react6.default.createElement("b", null, coverage.scored_trials ?? job.nValidScores ?? "\u2014", " / ", coverage.total_trials ?? job.nTrials ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("unscoredTrials")), /* @__PURE__ */ import_react6.default.createElement("b", null, coverage.unscored_trials ?? job.nUnscoredTrials ?? 0, " \xB7 completed-unscored"))) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("candidate")), /* @__PURE__ */ import_react6.default.createElement("b", null, candidate.candidate_id ?? "\u2014", " \xB7 ", candidate.version ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("dataset")), /* @__PURE__ */ import_react6.default.createElement("b", null, job.dataset?.dataset_id ?? "\u2014", " \xB7 ", job.dataset?.version ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("mode")), /* @__PURE__ */ import_react6.default.createElement("b", null, job.mode ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("progress")), /* @__PURE__ */ import_react6.default.createElement("b", null, progress.completed ?? 0, "/", progress.total ?? job.nTrials ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("validity")), /* @__PURE__ */ import_react6.default.createElement("b", null, typeof job.nValidScores === "number" ? `${t("validScores")} ${job.nValidScores}` : t("unavailable"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("exceptions")), /* @__PURE__ */ import_react6.default.createElement("b", null, job.nExceptions))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-progress", "aria-label": `${progress.percent ?? 0}%` }, /* @__PURE__ */ import_react6.default.createElement("i", { style: { width: `${progress.percent ?? 0}%` } })), /* @__PURE__ */ import_react6.default.createElement(MetricPills, { metrics: job.metrics }))), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-job-ask", onClick: () => void ask(job) }, t("askAi")));
}
function JsonSection({ title, value: value2 }) {
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, title), value2 ? /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-source" }, pretty2(value2)) : /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-muted" }, "\u2014"));
}
...
function trialRestoreView(value2 = {}) {
  const normalized = trialNavigationView({
    filters: value2.filters,
    sort: value2.sort,
    criterion: value2.focus?.criterion,
    evidenceRef: value2.focus?.evidenceRef,
    localObject: value2.focus?.localObject
  });
  return {
    ...normalized,
    trial: typeof value2.trial === "string" && value2.trial ? value2.trial : void 0,
    offset: Number.isInteger(value2.offset) && value2.offset >= 0 ? value2.offset : 0
  };
}
...
function TrialIssueActions({ detail, focused, onAsk, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-detail-group", ref, "data-highlight": String(selected) }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("exceptions"), " / ", t("validity")), objects.map((object, index) => /* @__PURE__ */ import_react6.default.createElement("p", { key: object.id }, reasons[index] ?? detail.lifecycle?.exception?.classification ?? detail.lifecycle?.exception?.type ?? t("exceptions"), " ", /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: object }, t("askFinding")) }, t("askAboutThis")))));
}
function TrialDetail({ state, t, focused, onFocus, onAsk, retry }) {
  const focusNodes = (0, import_react6.useRef)(/* @__PURE__ */ new Map());
  ...
  if (state?.status === "loading") return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "trial-detail", rows: 7, label: t("loadingTrial") }));
  if (state?.status === "error") return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.error, retry, t }));
  if (!detail) return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-detail hse-muted" }, t("selectTrialHint"));
  const assessment = detail.assessment;
  const attemptObject = detail.interactionObjects?.find((ref) => ref.kind === "attempt");
  if (!assessment) return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-detail" }, /* @__PURE__ */ import_react6.default.createElement(TrialIssueActions, { detail, focused, onAsk, t }), attemptObject ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: attemptObject }, t("askAttempt")) }, t("askAboutThis"), " \xB7 ", t("attempt")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-score" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, detail.lifecycle?.name ?? detail.trial), /* @__PURE__ */ import_react6.default.createElement("b", null, "\u2014")), /* @__PURE__ */ import_react6.default.createElement("span", null, detail.status)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("currentStatus")), /* @__PURE__ */ import_react6.default.createElement("pre", null, pretty2(detail.lifecycle))));
  ...
  const criteria = assessment.criteria ?? Object.entries(assessment.rewards ?? {}).map(([id, value2]) => ({ id, score: value2 }));
  const findingObjects = detail.interactionObjects?.filter((ref) => ref.kind === "finding") ?? [];
  return /* @__PURE__ */ import_react6.default.createElement("article", { className: "hse-trial-detail", "aria-live": "polite" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-score" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, t("score")), /* @__PURE__ */ import_react6.default.createElement("b", null, score.valid ? format2(score.value) : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("span", { className: unscored ? "hse-muted" : score.valid ? "hse-valid" : "hse-invalid" }, unscored ? "completed-unscored" : score.valid ? `\u2713 ${t("valid")}` : `\xD7 ${t("invalid")}`)), /* @__PURE__ */ import_react6.default.createElement(TrialIssueActions, { detail, focused, onAsk, t }), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("findings")), /* @__PURE__ */ import_react6.default.createElement("ul", null, (assessment.findings ?? []).length ? assessment.findings.map((item, index) => /* @__PURE__ */ import_react6.default.createElement("li", { key: index, ref: (node) => ownFocusNode(`local:${findingObjects[index]?.id}`, node), "data-highlight": String(Boolean(findingObjects[index]?.id) && focused?.localObject?.id === findingObjects[index]?.id) }, item.code ? `${item.code}: ` : "", item.message ?? String(item), findingObjects[index] ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: findingObjects[index] }, t("askFinding")) }, t("askAboutThis")) : null)) : /* @__PURE__ */ import_react6.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("recommendations")), /* @__PURE__ */ import_react6.default.createElement("ul", null, (assessment.recommendations ?? []).length ? assessment.recommendations.map((item, index) => /* @__PURE__ */ import_react6.default.createElement("li", { key: index }, item.message ?? String(item))) : /* @__PURE__ */ import_react6.default.createElement("li", null, "\u2014"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("output")), /* @__PURE__ */ import_react6.default.createElement(ArtifactPreview, { detail, t })), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("criteria")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-criteria" }, criteria.map((item) => /* @__PURE__ */ import_react6.default.createElement("div", { ref: (node) => ownFocusNode(`criterion:${item.id}`, node), className: "hse-criterion", "data-highlight": String(focused?.criterion === item.id), key: item.id, role: "button", tabIndex: 0, onClick: () => onFocus({ criterion: item.id }), onKeyDown: (event) => {
    if (event.key === "Enter" || event.key === " ") onFocus({ criterion: item.id });
  } }, /* @__PURE__ */ import_react6.default.createElement("span", null, item.label ?? item.id), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(item.score)), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: (event) => {
    event.stopPropagation();
    void onAsk({ criterion: item.id }, t("suggestedQuestion1"));
  } }, t("askAi")), (item.evidence_refs ?? []).map((ref) => /* @__PURE__ */ import_react6.default.createElement("button", { ref: (node) => ownFocusNode(evidenceFocusKey(item.id, ref), node), type: "button", className: "hse-inline-ask", "data-highlight": String(isEvidenceFocused(focused, item.id, ref)), key: ref, onClick: (event) => {
    event.stopPropagation();
    void onAsk({ criterion: item.id, evidenceRef: ref }, t("suggestedQuestion3"));
  } }, t("evidence"), " \xB7 ", short(ref))))))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("provenance")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-provenance" }, (assessment.evidence_provenance ?? assessment.evidence ?? []).map((item, index) => {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: !enabled, "data-highlight": String(enabled && isEvidenceFocused(focused, owners[0], ref)), key: ref ?? index, title: enabled ? item.artifact_ref : t("chooseCriterionEvidence"), onClick: () => enabled && void onAsk({ criterion: owners[0], evidenceRef: ref }, t("suggestedQuestion3")) }, item.label ?? item.kind ?? "Evidence");
  }))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-detail-group", ref: (node) => ownFocusNode(`local:${attemptObject?.id}`, node), "data-highlight": String(Boolean(attemptObject?.id) && focused?.localObject?.id === attemptObject?.id) }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("timing")), attemptObject ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void onAsk({ localObject: attemptObject }, t("askAttempt")) }, t("askAboutThis"), " \xB7 ", t("attempt"), " ", detail.lifecycle?.attempt) : null, /* @__PURE__ */ import_react6.default.createElement("pre", null, pretty2(assessment.process ?? detail.lifecycle))), /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-detail-group" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("audit")), /* @__PURE__ */ import_react6.default.createElement("pre", null, pretty2(assessment))));
}
...
function TrialSelectionBar({ job, workspace, checked, setChecked, restoredSelection, page, filters, contextFor, setContext, askContext, t }) {
  ...
  const owner = (0, import_react6.useRef)(0);
  const previousSnapshot = (0, import_react6.useRef)();
  const restoredSnapshot = (0, import_react6.useRef)();
  const installedChecked = (0, import_react6.useRef)();
  const scope = trialSelectionScope(workspace, job, filters, sessionId);
  const previousScope = (0, import_react6.useRef)(scope);
  const currentInput = (0, import_react6.useRef)();
  ...
  (0, import_react6.useEffect)(() => {
    ...
    if (restoredSelection && restoredSnapshot.current !== restoredSelection && restoredSelection.scope === scope && restoredSelection.checked === checked) {
      ...
      const value2 = restoredSelection.value;
      const context = contextFor({ trial: void 0, detail: void 0, selections: [value2.ref] });
      previousSnapshot.current = value2.ref;
      setState({ status: "ready", checked, scope, value: value2, context });
      setContext(context);
      return;
    }
  ...
  const select = async (mode, ask = false, question = t("askSelected")) => {
    ...
    try {
      ...
      const value2 = { ...snapshot2, ...membership };
      const context = contextFor({ trial: void 0, detail: void 0, selections: [value2.ref] });
      previousSnapshot.current = value2.ref;
      installedChecked.current = ids;
      setChecked(ids);
      setState({ status: "ready", checked: ids, scope, value: value2, context });
      setContext(context);
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-selection-bar" }, /* @__PURE__ */ import_react6.default.createElement("strong", null, t("selectedCount"), ": ", checked.length, snapshot ? ` \xB7 ${snapshot.mode}` : ""), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-local-actions" }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => setChecked([.../* @__PURE__ */ new Set([...checked, ...(page?.items ?? []).map((trial) => trial.id ?? trial.datasetTrial)])]) }, t("allVisible")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: !page?.total || state.status === "loading", onClick: () => void select("query-snapshot") }, t("selectFiltered"), " (", page?.total ?? 0, ")"), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: state.status === "loading" || !checked.length, onClick: () => snapshot ? void askContext(state.context, t("askSelected")) : void select("explicit", true) }, t("askSelected")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: state.status === "loading" || !checked.length || checked.length > 12, onClick: () => snapshot ? void askContext(state.context, t("askDiagnostic")) : void select("explicit", true, t("askDiagnostic")) }, t("prepareDiagnostic"), " (1\u201312)"), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => {
    owner.current += 1;
    previousSnapshot.current = void 0;
    installedChecked.current = void 0;
    setChecked([]);
  ...
  } }, t("clearSelection"))), state.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement("small", null, t("bindingContext")) : null, snapshot ? /* @__PURE__ */ import_react6.default.createElement("details", null, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("contextIdentity")), /* @__PURE__ */ import_react6.default.createElement("code", null, snapshot.ref.sourceDigest, " \xB7 ", snapshot.filterDigest, " \xB7 ", snapshot.expiresAt)) : null, state.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.error, t }) : null);
}
function TrialExplorer({ job, workspace, active, navigation, restoreView, onViewStateChange, onRestoreReady, onRestoreCancel, contextFor, setContext, resetContext, registerSelectionReader, askContext, t }) {
  ...
  const [checked, setChecked] = (0, import_react6.useState)([]);
  const [restoredSelection, setRestoredSelection] = (0, import_react6.useState)();
  const [selectionError, setSelectionError] = (0, import_react6.useState)();
  const selectionSequence = (0, import_react6.useRef)(0);
  const checkedScope = (0, import_react6.useRef)();
  const editChecked = (0, import_react6.useCallback)((next) => {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    setSelectionError(void 0);
    void requestApi("selection-detail", { workspace, ...ref }).then((value2) => {
      if (sequence !== selectionSequence.current || scope !== selectionScopeRef.current) return;
      const ids = trialSelectionMemberIds(value2, ref);
      checkedScope.current = scope;
      setChecked(ids);
      setRestoredSelection({ checked: ids, scope, value: value2 });
    }).catch((error) => {
  ...
  const [validity, setValidity] = (0, import_react6.useState)("");
  const [sort, setSort] = (0, import_react6.useState)("dataset-order");
  const selectionScopeRef = (0, import_react6.useRef)();
  selectionScopeRef.current = trialSelectionScope(workspace, job, { query, status, validity }, sessionId);
  const selectionInput = (0, import_react6.useRef)();
  selectionInput.current = { checked, scope: selectionScopeRef.current, contextFor, status, validity, sort };
  (0, import_react6.useEffect)(() => registerSelectionReader?.(() => {
  ...
  const [listState, setListState] = (0, import_react6.useState)({ status: "loading", stale: false });
  const [listRetry, setListRetry] = (0, import_react6.useState)(0);
  const [selected, setSelected] = (0, import_react6.useState)();
  const [detailState, setDetailState] = (0, import_react6.useState)({ status: "empty" });
  const [focused, setFocused] = (0, import_react6.useState)({});
  const [restoreSettled, setRestoreSettled] = (0, import_react6.useState)();
  const detailSequence = (0, import_react6.useRef)(0);
  const alive = (0, import_react6.useRef)(true);
  const handledNavigation = (0, import_react6.useRef)();
  const handledRestore = (0, import_react6.useRef)();
  const reportedRestore = (0, import_react6.useRef)();
  const restoreOwner = (0, import_react6.useRef)();
  const listRequestKey = (0, import_react6.useMemo)(
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const load = async () => {
      try {
        const value2 = await requestApi("trials", { workspace, job, offset, limit: 100, query, status, validity, sort });
        if (!cancelled) setListState(trialListSuccessState(listRequestKey, value2));
      } catch (error) {
  ...
  const cancelPendingRestore = (0, import_react6.useCallback)(() => {
    restoreOwner.current = void 0;
    setRestoreSettled(void 0);
    onRestoreCancel?.();
  }, [onRestoreCancel]);
  const choose = (0, import_react6.useCallback)(async (trial, focus2 = {}, view = {}, restoreId) => {
    ...
    let value2;
    try {
      value2 = await requestApi("trial", { workspace, job, trial });
    } catch (error) {
    ...
    setDetailState({ status: "ready", trial: String(trial), value: value2 });
    const context = contextFor({ trial, detail: value2, ...focus2, filters: view.filters ?? { status, validity }, sort: view.sort ?? sort });
    setContext(context);
  ...
  const focus = (value2) => {
    cancelPendingRestore();
    const next = mergeHarborFocus(focused, value2);
    if (value2.criterion === void 0 && value2.evidenceRef) delete next.criterion;
    setFocused(next);
    if (selected && detail) setContext(contextFor({ trial: selected, detail, ...next, filters: { status, validity }, sort }));
  };
  const ask = async (value2, prompt) => {
    const next = mergeHarborFocus(focused, value2);
  ...
  const selectionFilters = (0, import_react6.useMemo)(() => ({ query, status, validity, sort }), [query, status, validity, sort]);
  const emptyPage = Boolean(page && !page.items?.length);
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-layout" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-list" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-tools" }, /* @__PURE__ */ import_react6.default.createElement("input", { className: "hse-input", value: query, placeholder: t("search"), onChange: (event) => {
    cancelPendingRestore();
    setQuery(event.target.value);
    setOffset(0);
  } }), /* @__PURE__ */ import_react6.default.createElement("select", { className: "hse-select", value: status, onChange: (event) => {
    cancelPendingRestore();
    setStatus(event.target.value);
    setOffset(0);
  } }, /* @__PURE__ */ import_react6.default.createElement("option", { value: "" }, t("all")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "completed" }, "completed"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "completed-unscored" }, "completed-unscored"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "candidate-quality-failed" }, "candidate-quality-failed"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "infrastructure-error" }, "infrastructure-error"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "evaluation-error" }, "evaluation-error"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "running-agent" }, "running-agent"), /* @__PURE__ */ import_react6.default.createElement("option", { value: "evaluating" }, "evaluating")), /* @__PURE__ */ import_react6.default.createElement("select", { className: "hse-select", value: validity, onChange: (event) => {
    cancelPendingRestore();
    setValidity(event.target.value);
    setOffset(0);
  } }, /* @__PURE__ */ import_react6.default.createElement("option", { value: "" }, t("validity")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "true" }, t("valid")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "false" }, t("invalid"))), /* @__PURE__ */ import_react6.default.createElement("select", { className: "hse-select", value: sort, onChange: (event) => {
    cancelPendingRestore();
    setSort(event.target.value);
  } }, /* @__PURE__ */ import_react6.default.createElement("option", { value: "dataset-order" }, t("datasetOrder")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "latest-completed" }, t("latest")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "lowest-score" }, t("lowest")), /* @__PURE__ */ import_react6.default.createElement("option", { value: "errors" }, t("errorsFirst")))), selectionError ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: selectionError, t }) : null, /* @__PURE__ */ import_react6.default.createElement(TrialSelectionBar, { job, workspace, checked, setChecked: editChecked, restoredSelection, page, filters: selectionFilters, contextFor, setContext, askContext, t }), listState.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value2) => value2 + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "trial-list", rows: 6, label: t("loading") }) : emptyPage ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-filter-empty" }, /* @__PURE__ */ import_react6.default.createElement("b", null, filtered ? t("noFilteredTrials") : t("noData")), filtered ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: clearFilters }, t("clearFilters")) : null) : page ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, "#"), /* @__PURE__ */ import_react6.default.createElement("th", null, t("queryTrial")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("statusLabel")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("score")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("attempt")))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, page.items?.map((trial) => {
    const trialId = trial.id ?? trial.datasetTrial;
    return /* @__PURE__ */ import_react6.default.createElement("tr", { key: `${trial.id}-${trial.attempt}`, "data-selected": String(selected) === String(trialId) }, /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("input", { type: "checkbox", "aria-label": `${t("selectTrial")} ${trialId}`, checked: checked.includes(trialId), onChange: (event) => editChecked((current) => event.target.checked ? [.../* @__PURE__ */ new Set([...current, trialId])] : current.filter((id) => id !== trialId)) }), trial.datasetOrder + 1), /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-trial-name" }, /* @__PURE__ */ import_react6.default.createElement("button", { onClick: () => void choose(trialId) }, trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-trial-ask", onClick: () => void askTrial(trialId) }, t("askAi")))), /* @__PURE__ */ import_react6.default.createElement("td", null, t(trial.status)), /* @__PURE__ */ import_react6.default.createElement("td", null, trial.score?.valid ? format2(trial.score.value ?? trial.rewards?.reward) : "\u2014"), /* @__PURE__ */ import_react6.default.createElement("td", null, trial.attempt));
  })))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react6.default.createElement("span", null, page.total ? `${offset + 1}\u2013${Math.min(offset + (page.items?.length ?? 0), page.total)} / ${page.total}` : "0 / 0"), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !offset, onClick: () => {
    cancelPendingRestore();
    setOffset(Math.max(0, offset - 100));
  } }, t("previous")), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !page.hasMore, onClick: () => {
    cancelPendingRestore();
    setOffset(offset + 100);
  } }, t("next")))) : null), /* @__PURE__ */ import_react6.default.createElement(TrialDetail, { state: detailState, focused, onFocus: focus, onAsk: ask, retry: retryDetail, t }));
}
function DatasetPanel({ job, workspace, artifacts, t }) {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    void request("dataset", { workspace, job }).then(
      (value2) => alive && setState({ status: "ready", value: value2 }),
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "ID / version"), /* @__PURE__ */ import_react6.default.createElement("b", null, artifacts.dataset?.dataset_id ?? "\u2014", " \xB7 ", artifacts.dataset?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(artifacts.dataset?.source_digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("population")), /* @__PURE__ */ import_react6.default.createElement("b", null, artifacts.dataset?.task_count ?? dataset?.task_count ?? 0), /* @__PURE__ */ import_react6.default.createElement("code", null, badcases, " ", t("badcase"), " \xB7 ", dataset?.source === "job-snapshot" ? t("snapshot") : dataset?.source === "historical-source-fallback" ? t("historicalFallback") : "\u2014")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("datasetTasks")), state.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.error, retry: () => setRetry((value2) => value2 + 1), t }) : null, state.status === "loading" && !dataset ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "dataset", rows: 5, label: t("loading") }) : dataset ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-task-list" }, (dataset.tasks ?? []).map((task, index) => /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-task", key: task.id ?? index, open: index === 0 }, /* @__PURE__ */ import_react6.default.createElement("summary", null, index + 1, ". ", task.query || task.id || `task-${index + 1}`, /* @__PURE__ */ import_react6.default.createElement("span", { className: task.metadata?.badcase ? "hse-badcase" : void 0 }, task.metadata?.badcase ? `${t("badcase")} \xB7 ${task.metadata?.case_type}` : task.metadata?.topic ?? task.id ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-task-body" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("taskInstruction")), task.instruction ? /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-instruction" }, task.instruction) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, task.instruction_error ?? t("noData")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-inline-meta" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "ID: ", task.id ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("span", null, t("instructionFile"), ": ", task.instruction_file ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("span", null, t("datasetSource"), ": ", dataset.source === "job-snapshot" ? t("snapshot") : t("historicalFallback")), task.instruction_truncated ? /* @__PURE__ */ import_react6.default.createElement("span", null, t("attention")) : null))))) : null));
}
...
function CandidatePanel({ artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("experimentIdentity")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("experimentIdentityHint")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-identity-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("candidate")), /* @__PURE__ */ import_react6.default.createElement("b", null, candidate.candidate_id ?? "\u2014", " \xB7 ", candidate.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(candidate.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("dataset")), /* @__PURE__ */ import_react6.default.createElement("b", null, dataset.dataset_id ?? "\u2014", " \xB7 ", dataset.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, dataset.task_count ?? "\u2014", " Tasks \xB7 ", short(dataset.source_digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("evaluationStack")), /* @__PURE__ */ import_react6.default.createElement("b", null, stack.stack_id ?? "\u2014", " \xB7 ", stack.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(stack.comparison_digest ?? stack.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("runtime")), /* @__PURE__ */ import_react6.default.createElement("b", null, "Harbor ", runtime.harbor_version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, candidate.runtime?.policy ?? "unbound", " \xB7 Node ", candidate.runtime?.node_version ?? "\u2014", " \xB7 ", context.mode ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, candidate.runtime?.entrypoint ?? "\u2014", " \xB7 ", short(candidate.runtime?.lockfile_digest))))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("immutableCandidateFiles")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, t("file")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("size")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("digest")))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, (candidate.files ?? []).map((file) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: file.path }, /* @__PURE__ */ import_react6.default.createElement("td", null, file.path), /* @__PURE__ */ import_react6.default.createElement("td", null, file.size), /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("code", null, short(file.sha256))))))))));
}
function HistoricalTargetPanel({ detail, artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("historicalTarget")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("observationMode")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-identity-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("batch")), /* @__PURE__ */ import_react6.default.createElement("b", null, target.batch_id ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(target.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("generationRecords")), /* @__PURE__ */ import_react6.default.createElement("b", null, target.record_count ?? coverage.total_trials ?? "\u2014", " Trials"), /* @__PURE__ */ import_react6.default.createElement("code", null, target.kind ?? "\u2014", " \xB7 ", target.source_kind ?? source.kind ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("generationSource")), /* @__PURE__ */ import_react6.default.createElement("b", null, source.kind ?? target.source_kind ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, source.adapter_id ?? adapter.adapter_id ?? adapter.id ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("executionMode")), /* @__PURE__ */ import_react6.default.createElement("b", null, detail?.executionMode ?? summary.execution_mode ?? context.execution_mode ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, context.protocol ?? "\u2014")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("generatorPopulation")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, population?.homogeneous === false ? t("mixedPopulation") : population?.homogeneous === true ? t("homogeneousPopulation") : t("generatorPopulation")), /* @__PURE__ */ import_react6.default.createElement("b", null, generatorPopulationText(population, t)), /* @__PURE__ */ import_react6.default.createElement("code", null, population ? short(population.digest) : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react6.default.createElement("b", null, coverage.scored_trials ?? "\u2014", " / ", coverage.total_trials ?? target.record_count ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, t("unscoredTrials"), ": ", coverage.unscored_trials ?? 0, " \xB7 completed-unscored")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Trial coverage"), /* @__PURE__ */ import_react6.default.createElement("b", null, typeof coverage.trial_rate === "number" ? `${format2(coverage.trial_rate * 100)}%` : "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, t("scoredTrials"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Criterion coverage"), /* @__PURE__ */ import_react6.default.createElement("b", null, coverage.criterion_scored ?? "\u2014", " / ", coverage.criterion_total ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, typeof coverage.criterion_rate === "number" ? `${format2(coverage.criterion_rate * 100)}%` : "\u2014")))));
}
function ContractPanel({ artifacts, component, t }) {
  const contract = artifacts.contract ?? {};
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("integrationBoundary")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("integration")), /* @__PURE__ */ import_react6.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("scoringContract")), /* @__PURE__ */ import_react6.default.createElement("b", null, contract.contract_id ?? "\u2014", " \xB7 ", contract.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, t("primaryMetric"), ": ", contract.primary_metric ?? "\u2014")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("hardRequirements")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-chip-list" }, (contract.hard_requirements ?? []).map((item) => /* @__PURE__ */ import_react6.default.createElement("span", { key: item.id ?? item }, item.id ?? item)))));
}
function ArtifactPreview({ detail, t }) {
  const preview = detail?.preview;
  if (!preview) return /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-preview" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-preview-empty" }, t("noRenderableOutput")));
  const content = preview.content;
  const provenance = preview.provenance ?? [];
  let body;
  if (preview.kind === "page" && preview.format === "url" && preview.url) body = /* @__PURE__ */ import_react6.default.createElement("iframe", { className: "hse-page-frame", title: preview.title ?? t("pagePreview"), src: preview.url, sandbox: "", referrerPolicy: "no-referrer" });
  else if (preview.kind === "page" && preview.format === "html" && typeof content === "string") body = /* @__PURE__ */ import_react6.default.createElement("iframe", { className: "hse-page-frame", title: preview.title ?? t("pagePreview"), srcDoc: content, sandbox: "", referrerPolicy: "no-referrer" });
    ...
    body = /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-document" }, /* @__PURE__ */ import_react6.default.createElement("h4", null, t("documentPreview")), /* @__PURE__ */ import_react6.default.createElement("pre", null, primary ?? pretty2(content)), remainder && Object.keys(remainder).length ? /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("rawOutput")), /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-output-structured" }, pretty2(remainder))) : null);
  } else body = /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-output-structured" }, pretty2(content));
  return /* @__PURE__ */ import_react6.default.createElement("article", { className: "hse-preview" }, /* @__PURE__ */ import_react6.default.createElement("header", { className: "hse-preview-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, preview.title ?? t("generatedOutput")), /* @__PURE__ */ import_react6.default.createElement("span", null, preview.kind, " \xB7 ", preview.format)), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, t("previewSource")), /* @__PURE__ */ import_react6.default.createElement("span", null, provenance.map((item) => item.label ?? item.kind).join(" \xB7 ") || preview.source || "\u2014"))), body);
}
function RendererPanel({ job, workspace, active, component, contextFor, setContext, askContext, navigation, t }) {
  ...
  const [detailError, setDetailError] = (0, import_react6.useState)();
  (0, import_react6.useEffect)(() => {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const load = async () => {
      try {
        const value2 = await request("trials", { workspace, job, offset: 0, limit: 100, sort: "dataset-order" });
        if (cancelled) return;
        setListState(trialListSuccessState(listRequestKey, value2));
        setSelected((current) => current ?? value2.items?.[0]?.id ?? value2.items?.[0]?.datasetTrial);
      } catch (error) {
        if (!cancelled) setListState((current) => trialListFailureState(current, listRequestKey, error));
      }
    };
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("renderer")), /* @__PURE__ */ import_react6.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("generatedOutput")), /* @__PURE__ */ import_react6.default.createElement("b", null, page?.items?.length ?? 0, " Trials"), /* @__PURE__ */ import_react6.default.createElement("code", null, t("previewSource"), ": ", detail?.preview?.provenance?.map((item) => item.label ?? item.kind).join(" \xB7 ") || "\u2014")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("generatedOutput")), listState.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value2) => value2 + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "renderer-list", rows: 5, label: t("loading") }) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-output-layout" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-output-list" }, (page?.items ?? []).map((trial, index) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-output-item", "data-active": String(selected) === String(trial.id ?? trial.datasetTrial), key: `${trial.id}-${trial.attempt}`, onClick: () => setSelected(trial.id ?? trial.datasetTrial) }, /* @__PURE__ */ import_react6.default.createElement("b", null, index + 1, ". ", trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react6.default.createElement("span", null, t(trial.status), " \xB7 ", t("attempt"), " ", trial.attempt)))), detailError ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: detailError, t }) : /* @__PURE__ */ import_react6.default.createElement(ArtifactPreview, { detail, t }))));
}
function TrialAssessmentReport({ job, workspace, active, artifacts, historical = false, contextFor, setContext, askContext, navigation, restoreView, onViewStateChange, t }) {
  ...
  const [listRetry, setListRetry] = (0, import_react6.useState)(0);
  const [selected, setSelected] = (0, import_react6.useState)();
  const [detailState, setDetailState] = (0, import_react6.useState)({ status: "idle" });
  const [focused, setFocused] = (0, import_react6.useState)({});
  const contextForRef = (0, import_react6.useRef)(contextFor);
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const load = async () => {
      try {
        const value2 = await request("trials", { workspace, job, offset, limit: REPORT_PAGE_SIZE, sort: "dataset-order" });
        if (cancelled) return;
        setListState(trialListSuccessState(listRequestKey, value2));
        if (value2.items?.length) setSelected((current) => current ?? value2.items[0].id ?? value2.items[0].datasetTrial);
      } catch (error) {
        if (!cancelled) setListState((current) => trialListFailureState(current, listRequestKey, error));
      }
    };
  ...
  (0, import_react6.useEffect)(() => {
    ...
    void request("trial", { workspace, job, trial: selected }).then((value2) => alive && setDetailState({ status: "ready", value: value2 }), (error) => alive && setDetailState({ status: "error", error: normalizeHarborUiError(error) }));
    return () => {
      alive = false;
    };
  }, [request, workspace, job, selected]);
  ...
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("trialAssessments")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("trialAssessmentsHint")), listState.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: listState.errorDetails ?? listState.error, title: listState.stale ? t("trialListStale") : t("trialListUnavailable"), retry: () => setListRetry((value2) => value2 + 1), t }) : null, !page && listState.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "report-trial-list", rows: 5, label: t("loading") }) : page ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table hse-report-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, "#"), /* @__PURE__ */ import_react6.default.createElement("th", null, t("queryTrial")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("overallScore")), metricIds.map((id) => /* @__PURE__ */ import_react6.default.createElement("th", { key: id }, labels[id] ?? id)))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, (page.items ?? []).map((trial) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: `${trial.id}-${trial.attempt}`, "data-selected": String(selected) === String(trial.id ?? trial.datasetTrial) }, /* @__PURE__ */ import_react6.default.createElement("td", null, trial.datasetOrder + 1), /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => choose(trial.id ?? trial.datasetTrial) }, trial.displayName ?? trial.datasetTrial ?? trial.name), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void ask(trial.id ?? trial.datasetTrial) }, t("askAi"))), /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-report-score", "data-valid": trial.scoringStatus === "unscored" ? void 0 : trial.score?.valid }, trial.scoringStatus === "unscored" ? "completed-unscored" : trial.score?.valid ? format2(trial.score.value ?? trial.rewards?.[primary]) : "\u2014")), metricIds.map((id) => /* @__PURE__ */ import_react6.default.createElement("td", { key: id }, format2(trial.rewards?.[id])))))))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react6.default.createElement("span", null, page.total ? `${offset + 1}\u2013${Math.min(offset + (page.items?.length ?? 0), page.total)} / ${page.total}` : "0 / 0"), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !offset, onClick: () => setOffset(Math.max(0, offset - REPORT_PAGE_SIZE)) }, t("previous")), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !page.hasMore, onClick: () => setOffset(offset + REPORT_PAGE_SIZE) }, t("next")))) : null, detailState.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "report-trial-detail", rows: 6, label: t("loading") }) : detailState.status === "error" ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: detailState.error, t }) : assessment ? /* @__PURE__ */ import_react6.default.createElement("article", { className: "hse-report-detail" }, /* @__PURE__ */ import_react6.default.createElement("header", { className: "hse-report-detail-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h4", null, selectedTrial?.displayName ?? assessment.query ?? assessment.trial_name), /* @__PURE__ */ import_react6.default.createElement("span", null, t("artifact"), ": ", artifactTitle), /* @__PURE__ */ import_react6.default.createElement("code", null, assessment.dataset_trial ?? selectedTrial?.datasetTrial)), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, t("overallScore")), /* @__PURE__ */ import_react6.default.createElement("b", { className: selectedTrial?.scoringStatus === "unscored" ? "hse-muted" : score?.valid ? "hse-valid" : "hse-invalid" }, selectedTrial?.scoringStatus === "unscored" ? "completed-unscored" : score?.valid ? format2(score.value) : "\u2014"))), !score?.valid ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, selectedTrial?.scoringStatus === "unscored" && historical ? `${t("unscoredTrials")} \xB7 ` : "", (score?.invalid_reasons ?? []).join(" \xB7 ")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-report-compare" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-report-criteria" }, (assessment.criteria ?? []).map((criterion) => /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-report-criterion", key: criterion.id, "data-highlight": String(focused.criterion === criterion.id), ref: (node) => {
    if (node && focused.criterion === criterion.id && navigation?.actionId) node.scrollIntoView?.({ block: "center" });
  } }, /* @__PURE__ */ import_react6.default.createElement("header", null, /* @__PURE__ */ import_react6.default.createElement("b", null, criterion.label ?? labels[criterion.id] ?? criterion.id), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(criterion.score)), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void ask(selected, { criterion: criterion.id }) }, t("askAboutThis"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-chip-list" }, (criterion.evidence_refs ?? []).map((ref) => /* @__PURE__ */ import_react6.default.createElement("button", { key: ref, type: "button", "data-highlight": String(focused.evidenceRef === ref && focused.criterion === criterion.id), onClick: () => void ask(selected, { criterion: criterion.id, evidenceRef: ref }, t("suggestedQuestion3")) }, t("evidence"), " \xB7 ", short(ref)))), /* @__PURE__ */ import_react6.default.createElement("dl", null, /* @__PURE__ */ import_react6.default.createElement("dt", null, t("assessmentReason")), /* @__PURE__ */ import_react6.default.createElement("dd", null, criterion.reason || t("noAssessmentReason")), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("assessmentRecommendation")), /* @__PURE__ */ import_react6.default.createElement("dd", { className: "hse-report-recommendation" }, criterion.recommendation || t("noAssessmentRecommendation")))))), /* @__PURE__ */ import_react6.default.createElement(ArtifactPreview, { detail, t }))) : null);
}
function ReporterPanel({ job, workspace, active, artifacts, jobKind, interaction, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("populationEvidence")), configured ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(configured.executed) }, /* @__PURE__ */ import_react6.default.createElement("b", null, t("hookExecution"), ": ", configured.id ?? "\u2014", " \xB7 ", configured.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("br", null), configured.executed ? t("configuredHookRun") : t("configuredHookNotRun")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("trials")), /* @__PURE__ */ import_react6.default.createElement("b", null, total)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, historical ? t("scoredTrials") : t("valid")), /* @__PURE__ */ import_react6.default.createElement("b", { className: "hse-valid" }, valid ?? "\u2014")), historical ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("unscoredTrials")), /* @__PURE__ */ import_react6.default.createElement("b", null, unscored)) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("invalid")), /* @__PURE__ */ import_react6.default.createElement("b", { className: "hse-invalid" }, summary.n_invalid_scores ?? population.invalid_population_size ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("exceptions")), /* @__PURE__ */ import_react6.default.createElement("b", null, summary.n_exceptions ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react6.default.createElement("b", null, historical && typeof coverage.trial_rate === "number" ? `${format2(coverage.trial_rate * 100)}%` : summary.artifact_validation?.valid ? "VALID" : "CHECK")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, t("metric")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("aggregate")), /* @__PURE__ */ import_react6.default.createElement("th", null, t("coverage")))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, Object.entries(metrics).map(([id, value2]) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: id }, /* @__PURE__ */ import_react6.default.createElement("td", null, /* @__PURE__ */ import_react6.default.createElement("b", null, labels[id] ?? id), /* @__PURE__ */ import_react6.default.createElement("br", null), /* @__PURE__ */ import_react6.default.createElement("code", null, id)), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(value2)), /* @__PURE__ */ import_react6.default.createElement("td", null, valid ?? "\u2014", " / ", total))))))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("trialGroups")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-chip-list" }, groups.map((group) => /* @__PURE__ */ import_react6.default.createElement("span", { key: group.id }, group.id, ": ", group.count)))), /* @__PURE__ */ import_react6.default.createElement(TrialAssessmentReport, { job, workspace, active, artifacts, historical, ...interaction, t }));
}
function TrialDeltaTable({ title, items }) {
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, title, " \xB7 ", items?.length ?? 0), items?.length ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, "Trial"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Delta"))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, items.map((item) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: item.trial }, /* @__PURE__ */ import_react6.default.createElement("td", null, item.trial), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(item.baseline)), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(item.candidate)), /* @__PURE__ */ import_react6.default.createElement("td", { className: "hse-delta", "data-positive": (item.delta ?? 0) >= 0 }, item.delta >= 0 ? "+" : "", format2(item.delta))))))) : /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-muted" }, "0"));
}
function TrialIssueTable({ title, items }) {
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, title, " \xB7 ", items?.length ?? 0), items?.length ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, "Trial"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Reason"))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, items.map((item) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: item.trial }, /* @__PURE__ */ import_react6.default.createElement("td", null, item.trial), /* @__PURE__ */ import_react6.default.createElement("td", null, item.baselineStatus ?? (item.baselineValid === true ? "valid" : item.baselineValid === false ? "invalid" : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("td", null, item.candidateStatus ?? (item.candidateValid === true ? "valid" : item.candidateValid === false ? "invalid" : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("td", null, item.invalidReasons?.join(" \xB7 ") || item.exception?.message || item.exception?.code || "\u2014")))))) : /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-muted" }, "0"));
}
...
function ComparePanel({ job, workspace, jobs, artifacts, gate, navigation, restoreView, onViewStateChange, contextFor, setContext, askContext, t }) {
  ...
  const [baseline, setBaseline] = (0, import_react6.useState)(() => candidates.some((item) => item.name === restoreView?.compareBaseline) ? restoreView.compareBaseline : candidates[0]?.name ?? "");
  const handledRestore = (0, import_react6.useRef)();
  ...
  (0, import_react6.useEffect)(() => {
    ...
    void request("compare", { workspace, baseline: effectiveBaseline, candidate: job }).then(
      (value2) => {
        if (alive) setState({ requestKey: comparisonKey, status: "ready", value: value2 });
      },
      (error) => {
  ...
  const compareContext = (0, import_react6.useMemo)(() => comparison ? contextFor({ comparison, gate: void 0 }) : void 0, [comparison, contextFor]);
  ...
  const labels = metricLabelMap(artifacts);
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("compare")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", disabled: !compareContext, onClick: () => compareContext && void askContext(compareContext, t("suggestedQuestion4")) }, t("askAi"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-compare-select" }, /* @__PURE__ */ import_react6.default.createElement("select", { className: "hse-select", value: effectiveBaseline, onChange: (event) => setBaseline(event.target.value) }, /* @__PURE__ */ import_react6.default.createElement("option", { value: "" }, t("baseline")), candidates.map((item) => /* @__PURE__ */ import_react6.default.createElement("option", { key: item.name, value: item.name }, item.name)))), currentState?.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value2) => value2 + 1), t }) : comparison ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("div", { className: comparison.comparable ? "hse-valid" : "hse-invalid" }, comparison.comparable ? `\u2713 ${t("comparable")}` : `\xD7 ${t("notComparable")}`), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, comparison.note), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, Object.entries(comparison.metrics ?? {}).map(([metric, values]) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card", key: metric }, /* @__PURE__ */ import_react6.default.createElement("span", null, labels[metric] ?? metric, " \xB7 ", values.direction), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(values.baseline), " \u2192 ", format2(values.candidate)), /* @__PURE__ */ import_react6.default.createElement("code", { className: "hse-delta", "data-positive": (values.improvement ?? values.delta ?? 0) >= 0 }, typeof values.delta === "number" ? `${values.delta >= 0 ? "+" : ""}${format2(values.delta)}` : "\u2014"))))) : /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-muted" }, currentState?.status === "loading" ? t("loading") : t("noData"))), comparison ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement(TrialDeltaTable, { title: t("improved"), items: comparison.improvedTrials }), /* @__PURE__ */ import_react6.default.createElement(TrialDeltaTable, { title: t("regressed"), items: comparison.regressedTrials }), /* @__PURE__ */ import_react6.default.createElement(TrialIssueTable, { title: t("invalidTrials"), items: comparison.invalidTrials }), /* @__PURE__ */ import_react6.default.createElement(TrialIssueTable, { title: t("newInfrastructureExceptions"), items: comparison.newInfrastructureExceptions })) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, t("explicitGate")));
}
function LocalObjectActions({ object, contextFor, setContext, askContext, prompt, navigation, t }) {
  const root = (0, import_react6.useRef)();
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", { ref: root, className: "hse-local-actions", "data-highlight": String(selected) }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => setContext?.(context()) }, t("selectObject")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(), prompt) }, t("askAboutThis")), /* @__PURE__ */ import_react6.default.createElement("code", null, short(object.sourceDigest)));
}
function OptimizerPanel({ artifacts, interactionObjects = [], contextFor, setContext, askContext, navigation, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("controlledHypotheses")), configured ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(configured.executed) }, /* @__PURE__ */ import_react6.default.createElement("b", null, t("hookExecution"), ": ", configured.id ?? "\u2014", " \xB7 ", configured.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("br", null), configured.executed ? t("configuredHookRun") : t("configuredHookNotRun")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Diagnoser"), /* @__PURE__ */ import_react6.default.createElement("b", null, diagnosis.hook?.id ?? "\u2014", " \xB7 ", diagnosis.hook?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, diagnoses.length, " diagnoses \xB7 non-reward-affecting")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("pluginFallback")), /* @__PURE__ */ import_react6.default.createElement("b", null, optimization.hook?.id ?? "\u2014", " \xB7 ", optimization.hook?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, hypotheses.length, " hypotheses \xB7 non-reward-affecting")))), diagnoses.length ? /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, "Diagnoses"), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-findings" }, diagnoses.map((item, index) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-finding", key: item.id ?? index }, item.message ?? item.root_cause ?? pretty2(item))))) : null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hypotheses" }, hypotheses.length ? hypotheses.map((item, index) => /* @__PURE__ */ import_react6.default.createElement("article", { className: "hse-hypothesis", key: item.id }, /* @__PURE__ */ import_react6.default.createElement("h4", null, item.id), /* @__PURE__ */ import_react6.default.createElement(LocalObjectActions, { object: interactionObjects.filter((ref) => ref.kind === "hypothesis")[index], contextFor, setContext, askContext, prompt: t("askHypothesis"), navigation, t }), /* @__PURE__ */ import_react6.default.createElement("dl", null, /* @__PURE__ */ import_react6.default.createElement("dt", null, t("rootCause")), /* @__PURE__ */ import_react6.default.createElement("dd", null, item.root_cause ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("affectedTrials")), /* @__PURE__ */ import_react6.default.createElement("dd", null, item.affected_trials?.length ?? 0), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("expectedEffect")), /* @__PURE__ */ import_react6.default.createElement("dd", null, item.expected_metric_effect ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("mutationSurface")), /* @__PURE__ */ import_react6.default.createElement("dd", null, Array.isArray(item.mutation_surface) ? item.mutation_surface.join(" \xB7 ") : item.mutation_surface || "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("forbiddenSurface")), /* @__PURE__ */ import_react6.default.createElement("dd", null, Array.isArray(item.forbidden_surface) ? item.forbidden_surface.join(" \xB7 ") : item.forbidden_surface || "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("guardrails")), /* @__PURE__ */ import_react6.default.createElement("dd", null, Array.isArray(item.guardrails) ? item.guardrails.join(" \xB7 ") : item.guardrails || "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("rollback")), /* @__PURE__ */ import_react6.default.createElement("dd", null, item.rollback_condition ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("dt", null, t("nextExperiment")), /* @__PURE__ */ import_react6.default.createElement("dd", null, item.next_experiment ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("provenance"), " \xB7 ", item.evidence_refs?.length ?? 0), /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-source" }, pretty2(item.evidence_refs))))) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-empty" }, t("noHypotheses")))));
}
function GateEvidencePanel({ artifacts, interactionObjects = [], contextFor, setContext, askContext, navigation, t }) {
  ...
  if (!report) return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-muted" }, t("noData")));
  const labels = metricLabelMap(artifacts);
  const pass = report.decision === "PROMOTE";
  const population = report.population ?? {};
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, report.baseline_job ?? "\u2014", " \u2192 ", report.candidate_job ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-decision", "data-pass": pass }, report.decision ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("comparable")), /* @__PURE__ */ import_react6.default.createElement("b", { className: report.comparable ? "hse-valid" : "hse-invalid" }, report.comparable ? "\u2713 TRUE" : "\xD7 FALSE"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(report.baseline_evaluation_context?.digest), " = ", short(report.candidate_evaluation_context?.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, report.gate_eligible ? t("eligible") : t("notEligible")), /* @__PURE__ */ import_react6.default.createElement("b", { className: report.gate_eligible ? "hse-valid" : "hse-invalid" }, population.baseline_valid ?? "\u2014", " / ", population.baseline ?? "\u2014", " \u2192 ", population.candidate_valid ?? "\u2014", " / ", population.candidate ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, t("policy"), ": ", report.policy?.policy_id ?? "\u2014", " \xB7 ", report.policy?.version ?? "\u2014")))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("metricDeltas")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, t("metric")), /* @__PURE__ */ import_react6.default.createElement("th", null, "Baseline"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Candidate"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Delta"))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, Object.entries(report.metric_deltas ?? {}).map(([id, delta]) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: id }, /* @__PURE__ */ import_react6.default.createElement("td", null, labels[id] ?? id), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(report.baseline_metrics?.[id])), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(report.candidate_metrics?.[id])), /* @__PURE__ */ import_react6.default.createElement("td", { className: "hse-delta", "data-positive": delta >= 0 }, delta >= 0 ? "+" : "", format2(delta)))))))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("improved")), /* @__PURE__ */ import_react6.default.createElement("b", null, report.improved_trials?.length ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("regressed")), /* @__PURE__ */ import_react6.default.createElement("b", null, report.regressed_trials?.length ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("newExceptions")), /* @__PURE__ */ import_react6.default.createElement("b", null, report.new_exceptions?.length ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("artifactRegressions")), /* @__PURE__ */ import_react6.default.createElement("b", null, report.artifact_regressions?.length ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("reasons")), /* @__PURE__ */ import_react6.default.createElement("b", null, report.reasons?.length ?? 0))), report.reasons?.length ? /* @__PURE__ */ import_react6.default.createElement("ul", null, report.reasons.map((reason, index) => /* @__PURE__ */ import_react6.default.createElement("li", { key: `${gateReasonText(reason)}-${index}` }, gateReasonText(reason), /* @__PURE__ */ import_react6.default.createElement(LocalObjectActions, { object: interactionObjects.filter((ref) => ref.kind === "gate-reason")[index], contextFor, setContext, askContext, prompt: t("askGateReason"), navigation, t })))) : null));
}
function HistoricalGatePanel({ t }) {
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-gate-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("gateEvidence")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("gateNotApplicableHint"))), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-decision" }, t("gateNotApplicable"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react6.default.createElement("b", null, "UNSUPPORTED_JOB_KIND_FOR_PROMOTION"), /* @__PURE__ */ import_react6.default.createElement("br", null), "historical-generation-evaluation \xB7 diagnostic \xB7 observe-existing"));
}
...
function EvaluatorEditor(props) {
  const update = useHarborMutation();
  const sessionId = (0, import_react6.useContext)(HarborSessionContext);
  return /* @__PURE__ */ import_react6.default.createElement(EvaluatorEditorView, { ...props, sessionId: String(sessionId), update, ErrorState: HarborErrorState, applySourceProposal, nextVersion });
}
...
function SavedSourceFragment({ component, object, contextFor, setContext, askContext, navigation, t }) {
  ...
  const [range, setRange] = (0, import_react6.useState)({ startLine: 1, endLine: Math.min(String(source ?? "").split("\n").length, 200) });
  const input = (0, import_react6.useRef)();
  (0, import_react6.useEffect)(() => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section hse-saved-source" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, component.id, " \xB7 ", t("sourceSelection")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("sourceSaved")), /* @__PURE__ */ import_react6.default.createElement("textarea", { ref: input, className: "hse-editor", readOnly: true, value: source, "aria-label": `${t("sourceSelection")} ${object.sourceRole}`, onSelect: select }), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-local-actions" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "L", range.startLine, "\u2013", range.endLine), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(range), t("askSource")) }, t("askSourceLabel")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-inline-ask", onClick: () => void askContext(context(range), t("askSourceChange")) }, t("askSourceChangeLabel"))));
}
function GovernancePanel({ job, workspace, contextFor, setContext, askContext, navigation, proposal, t }) {
  ...
  const activeGovernanceKey = (0, import_react6.useRef)(requestKey);
  activeGovernanceKey.current = requestKey;
  const requestSequence = (0, import_react6.useRef)(0);
  const [state, setState] = (0, import_react6.useState)({ requestKey, status: "loading" });
  const [copied, setCopied] = (0, import_react6.useState)(false);
  const [saveReceipt, setSaveReceipt] = (0, import_react6.useState)();
  const load = (0, import_react6.useCallback)(async () => {
    ...
    try {
      const value3 = await request("governance", { workspace, job });
      if (!ownsGovernanceRequest(activeGovernanceKey.current, requestKey, requestSequence.current, sequence)) return void 0;
      setState({ requestKey, status: "ready", value: value3 });
      if (value3.savedEvaluatorVersion) setSaveReceipt({ requestKey, value: value3.savedEvaluatorVersion });
      else if (value3.savedEvaluatorRecovery?.status === "UNAVAILABLE") {
  ...
  const bindingIsCurrent = (0, import_react6.useCallback)((loadedKey) => ownsGovernanceBinding(activeGovernanceKey.current, loadedKey), []);
  const receipt = saveReceipt?.requestKey === requestKey ? /* @__PURE__ */ import_react6.default.createElement(SavedEvaluatorNextSteps, { receipt: saveReceipt.value, historicalJob: job, onPreparePlan: (prompt2) => askContext(contextFor({}), prompt2), t }) : null;
  const currentState = state.requestKey === requestKey ? state : { requestKey, status: "loading" };
  if (currentState.status === "loading") return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, receipt, /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "governance", rows: 6, label: t("loading") }));
  if (currentState.status === "error") return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, receipt, /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: currentState.error, retry: () => void load(), t }));
  const value2 = currentState.value;
  const evaluator = value2.components?.evaluator;
  const effectiveEvaluator = value2.effectiveEvaluator;
  const executedEvaluator = effectiveEvaluator?.executed ?? effectiveEvaluator?.configured;
  const effectiveStatus = effectiveEvaluator?.status === "verified" ? t("evaluatorVerified") : effectiveEvaluator?.status === "mismatch" ? t("evaluatorMismatch") : effectiveEvaluator?.status === "unattested" ? t("evaluatorUnattested") : t("evaluatorUnknown");
  const rubric = value2.components?.rubric;
  const workflow = value2.upgradeWorkflow ?? {};
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, receipt, value2.savedEvaluatorRecovery?.status === "UNAVAILABLE" ? /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section", role: "alert" }, /* @__PURE__ */ import_react6.default.createElement("p", null, t("savedVersionRecoveryUnavailable")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-button", onClick: () => void load() }, t("refresh"))) : null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("currentEvaluator")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("governanceHint")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-governance-id" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("effectiveEvaluator")), /* @__PURE__ */ import_react6.default.createElement("b", null, executedEvaluator?.id ?? "\u2014", " \xB7 ", executedEvaluator?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, effectiveStatus)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("rubric")), /* @__PURE__ */ import_react6.default.createElement("b", null, rubric?.id ?? "\u2014", " \xB7 ", rubric?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, rubric?.entry ?? "\u2014")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Judge"), /* @__PURE__ */ import_react6.default.createElement("b", null, value2.judge?.provider ?? "\u2014", " / ", value2.judge?.model ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, judgeIdentityDetails(value2.judge))))), value2.editingPolicy?.identityMatch ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t(value2.editingPolicy.forkFromExecuted ? "evaluatorForkExecuted" : "evaluatorEditExecuted")) : null, /* @__PURE__ */ import_react6.default.createElement(EvaluatorEditor, { proposal, job, value: value2, workspace, bindingKey: currentState.requestKey, bindingIsCurrent, reload: load, onSaved: (value3) => setSaveReceipt({ requestKey, value: value3 }), t }), ["evaluator", "rubric"].map((role) => /* @__PURE__ */ import_react6.default.createElement(SavedSourceFragment, { key: role, component: value2.components?.[role], object: value2.interactionObjects?.find((ref) => ref.sourceRole === role), contextFor, setContext, askContext, navigation, t })), [["evaluator", evaluator], ["rubric", rubric]].map(([role, component]) => /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section", key: role }, /* @__PURE__ */ import_react6.default.createElement("h3", null, role === "evaluator" ? t("evaluator") : t("rubric"), " \xB7 ", component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("sourceCode")), /* @__PURE__ */ import_react6.default.createElement("b", null, component?.entry ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(component?.digest))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Reward semantics"), /* @__PURE__ */ import_react6.default.createElement("b", null, component?.reward_affecting ? "reward-affecting" : "non-reward"), /* @__PURE__ */ import_react6.default.createElement("code", null, component?.source?.error ?? "read-only"))), component?.source?.text ? /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-source-details" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("sourceCode")), /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-source" }, component.source.text)) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, component?.source?.error))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section hse-upgrade" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("upgradeEvaluator")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("upgradeHint")), /* @__PURE__ */ import_react6.default.createElement("ol", null, [1, 2, 3, 4, 5].map((index) => /* @__PURE__ */ import_react6.default.createElement("li", { key: index }, t(`upgradeStep${index}`)))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("freshBaseline")), /* @__PURE__ */ import_react6.default.createElement("b", null, "Evaluator / Rubric / Judge identity"), /* @__PURE__ */ import_react6.default.createElement("code", null, (workflow.freshBaselineRequiredWhen ?? []).join(" \xB7 "))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("metaEvaluation")), /* @__PURE__ */ import_react6.default.createElement("b", null, "Independent GT \xB7 ESF \xB7 SCE \xB7 RCR"), /* @__PURE__ */ import_react6.default.createElement("code", null, "No automatic evaluation or Gate"))), /* @__PURE__ */ import_react6.default.createElement("pre", { className: "hse-prompt" }, prompt), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-prompt-actions" }, /* @__PURE__ */ import_react6.default.createElement("button", { className: "hse-button", type: "button", onClick: () => void copy2() }, copied ? t("copied") : t("copyPrompt")))));
}
function MetaEvaluationPanel({ job, workspace, t }) {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    void request("meta", { workspace, job, offset, limit: pageSize }).then(
      (value3) => alive && setState({ requestKey, status: "ready", value: value3, loadedOffset: offset, error: void 0 }),
  ...
  const currentState = state.requestKey === requestKey ? state : { requestKey, status: "loading" };
  if (currentState.status === "loading" && !currentState.value) return /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "meta", rows: 7, label: t("loading") });
  if (currentState.status === "error" && !currentState.value) return /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value3) => value3 + 1), t });
  const value2 = currentState.value ?? {};
  const groundTruth = value2.groundTruth;
  const report = value2.report;
  const metrics = report?.metrics ?? {};
  const pagination = value2.disagreementPagination ?? {};
  const loadedOffset = currentState.loadedOffset ?? offset;
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, currentState.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: currentState.error, retry: () => setRetry((value3) => value3 + 1), t }) : null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("metaWorkflow")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("metaWorkflowHint")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-meta-flow" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, "1. Evaluator Candidate"), /* @__PURE__ */ import_react6.default.createElement("br", null), value2.workflow?.candidate), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, "2. Fixed artifacts + GT"), /* @__PURE__ */ import_react6.default.createElement("br", null), value2.workflow?.dataset), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, "3. Repeated observations"), /* @__PURE__ */ import_react6.default.createElement("br", null), value2.workflow?.output), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, "4. ESF / SCE / RCR"), /* @__PURE__ */ import_react6.default.createElement("br", null), value2.workflow?.verifier))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("groundTruth")), groundTruth ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "ID / version"), /* @__PURE__ */ import_react6.default.createElement("b", null, groundTruth.id, " \xB7 ", groundTruth.version), /* @__PURE__ */ import_react6.default.createElement("code", null, groundTruth.path)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("gtSource")), /* @__PURE__ */ import_react6.default.createElement("b", null, groundTruth.source?.kind), /* @__PURE__ */ import_react6.default.createElement("code", null, groundTruth.source?.description)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("gtCases")), /* @__PURE__ */ import_react6.default.createElement("b", null, groundTruth.caseCount), /* @__PURE__ */ import_react6.default.createElement("code", null, groundTruth.criteria?.map((item) => item.label ?? item.id).join(" \xB7 "))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("gtBadcases")), /* @__PURE__ */ import_react6.default.createElement("b", null, groundTruth.badcaseCount), /* @__PURE__ */ import_react6.default.createElement("code", null, t("gtProvenance"), ": ", groundTruth.source?.provenance)))) : /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, /* @__PURE__ */ import_react6.default.createElement("b", null, t("groundTruthRequired")), /* @__PURE__ */ import_react6.default.createElement("br", null), t("gtKinds")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hook-state", "data-executed": Boolean(report) }, /* @__PURE__ */ import_react6.default.createElement("b", null, t("metaNext")), /* @__PURE__ */ import_react6.default.createElement("br", null), value2.workflow?.nextAction)), report ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, "Evaluator \xB7 ", report.evaluator?.id, " \xB7 ", report.evaluator?.version), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpis" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "ESF \u2191"), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(metrics.esf))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "SCE \u2193"), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(metrics.sce))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "RCR \u2191"), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(metrics.rcr))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("coverage")), /* @__PURE__ */ import_react6.default.createElement("b", null, format2(report.coverage?.rate))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-kpi" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("disagreements")), /* @__PURE__ */ import_react6.default.createElement("b", null, pagination.total ?? report.disagreements?.length ?? 0)))), pagination.total ? /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("disagreements")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-table-wrap" }, /* @__PURE__ */ import_react6.default.createElement("table", { className: "hse-evidence-table" }, /* @__PURE__ */ import_react6.default.createElement("thead", null, /* @__PURE__ */ import_react6.default.createElement("tr", null, /* @__PURE__ */ import_react6.default.createElement("th", null, "Case"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Criterion"), /* @__PURE__ */ import_react6.default.createElement("th", null, "GT"), /* @__PURE__ */ import_react6.default.createElement("th", null, "Observed"))), /* @__PURE__ */ import_react6.default.createElement("tbody", null, (report.disagreements ?? []).map((item, index) => /* @__PURE__ */ import_react6.default.createElement("tr", { key: `${item.case_id}-${item.repeat}-${item.criterion_id}-${index}` }, /* @__PURE__ */ import_react6.default.createElement("td", null, item.case_id), /* @__PURE__ */ import_react6.default.createElement("td", null, item.criterion_id), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(item.ground_truth)), /* @__PURE__ */ import_react6.default.createElement("td", null, format2(item.observed))))))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react6.default.createElement("span", null, pagination.total ? `${loadedOffset + 1}\u2013${Math.min(loadedOffset + (report.disagreements?.length ?? 0), pagination.total)} / ${pagination.total}` : "0 / 0"), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !loadedOffset, onClick: () => setOffset(Math.max(0, loadedOffset - pageSize)) }, t("previous")), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !pagination.hasMore, onClick: () => setOffset(loadedOffset + pageSize) }, t("next")))) : null) : null);
}
function HistoricalMetaEvaluationPanel({ detail, artifacts, t }) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("meta")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("metaNotRunHint")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("currentStatus")), /* @__PURE__ */ import_react6.default.createElement("b", null, notRun ? t("metaNotRun") : metaEvaluation.status ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, context.protocol ?? "historical-generation-evaluation-context/v3")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, "Validation report"), /* @__PURE__ */ import_react6.default.createElement("b", null, metaEvaluation.validation_report_ref ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, notRun ? "Evaluator reliability remains unvalidated" : short(metaEvaluation.digest)))));
}
...
function JobIdentityHeader({ context, summary, t }) {
  return /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-job-identities" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("identityDetails"), " \xB7 ", t("progress"), ": ", summary?.progress?.completed ?? 0, "/", summary?.progress?.total ?? summary?.nTrials ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-identity-tags" }, ["candidate", "dataset", "context", "stack"].map((role) => {
    const value2 = context?.identities?.[role];
    return /* @__PURE__ */ import_react6.default.createElement("span", { key: role }, /* @__PURE__ */ import_react6.default.createElement("small", null, role), /* @__PURE__ */ import_react6.default.createElement("b", { title: value2?.digest }, value2?.id ?? "\u2014", value2?.version ? ` @ ${value2.version}` : ""), /* @__PURE__ */ import_react6.default.createElement("code", null, short(value2?.digest)));
  })), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-identity-flags" }, /* @__PURE__ */ import_react6.default.createElement(ContextFlags, { context, t }), /* @__PURE__ */ import_react6.default.createElement("span", null, t("mode"), ": ", summary?.mode ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("span", null, t("validity"), ": ", summary?.nValidScores ?? "\u2014", " / ", summary?.nTrials ?? "\u2014")));
}
function JobSummaryPanel({ detail, summary, contextFor, setContext, askContext, navigation, openSection, t }) {
  if (detail?.report) return /* @__PURE__ */ import_react6.default.createElement(EvaluationResult, { report: detail.report, openSection, t });
  const attention = summary ? jobAttention(summary) : void 0;
  const metrics = Object.entries(detail?.artifacts?.summary?.metrics ?? {}).slice(0, 100).filter(([, value2]) => typeof value2 === "number" && Number.isFinite(value2));
  const objects = detail?.interactionObjects ?? [];
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section hse-job-summary" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-summary-status" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("health"), ": ", attention ? t(`health_${attention.kind}`) : t("unavailable")), /* @__PURE__ */ import_react6.default.createElement("p", null, t("askHealth"))), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-ask", onClick: () => void askContext(contextFor({}), t("askHealth")) }, t("askAi"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-summary-metrics" }, metrics.length ? metrics.map(([name2, value2], index) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-summary-metric", key: name2 }, /* @__PURE__ */ import_react6.default.createElement("span", null, name2), /* @__PURE__ */ import_react6.default.createElement("strong", null, format2(value2)), /* @__PURE__ */ import_react6.default.createElement(LocalObjectActions, { object: objects.filter((ref) => ref.kind === "metric")[index], contextFor, setContext, askContext, navigation, prompt: t("askMetric"), t }))) : /* @__PURE__ */ import_react6.default.createElement("p", null, t("noMetric"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-summary-links" }, ["trials", "optimization", "compare", "evaluator"].map((section) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-button", key: section, onClick: () => openSection(section) }, t(`jobSection_${section}`), " \u2192"))));
}
function Workbench({ job, workspace, jobs, close, navigation, navigationRevision, consumeNavigation, restoreView, hasHistory, scrollContainerRef, onViewStateChange, sessionId, pageSessionId, bridge, askContext, t }) {
  ...
  const request = useHarborApi();
  const [state, setState] = (0, import_react6.useState)({ status: "loading" });
  const [stage, setStage] = (0, import_react6.useState)(() => STAGES.includes(restoreView?.stage) ? restoreView.stage : "candidate");
  const [section, setSection] = (0, import_react6.useState)(() => JOB_SECTIONS.includes(restoreView?.section) ? restoreView.section : sectionForNavigation(navigation?.target));
  const openSection = (value2) => {
    setSection(value2);
    setStage(value2 === "trials" || value2 === "evaluator" ? "judge" : value2 === "optimization" ? "optimizer" : value2 === "compare" ? "gate" : "candidate");
  };
  const childContext = (0, import_react6.useRef)();
  const requestSequence = (0, import_react6.useRef)(0);
  const handledRestore = (0, import_react6.useRef)();
  const restoredScroll = (0, import_react6.useRef)();
  const restoreFrames = (0, import_react6.useRef)([]);
  const restoreObserver = (0, import_react6.useRef)();
  const restoreTimer = (0, import_react6.useRef)();
  const activeRestoreId = (0, import_react6.useRef)(restoreView?.restoreId);
  activeRestoreId.current = restoreView?.restoreId;
  const trialViewState = (0, import_react6.useRef)(restoreView?.trialView);
  const compareBaselineState = (0, import_react6.useRef)(restoreView?.compareBaseline);
  const gateRouteState = (0, import_react6.useRef)(
  ...
  const load = (0, import_react6.useCallback)(async () => {
    const sequence = ++requestSequence.current;
    try {
      const value2 = await request("job", { workspace, job });
      if (sequence === requestSequence.current) setState(workbenchSuccessState(value2));
    } catch (error) {
  ...
  const stopRestoredScroll = (0, import_react6.useCallback)(() => {
  ...
  const applyRestoredScroll = (0, import_react6.useCallback)((restoreId) => {
  ...
  (0, import_react6.useEffect)(() => stopRestoredScroll, [stopRestoredScroll]);
  ...
  const contextScope = (0, import_react6.useMemo)(() => ({}), [job, workspace, section, stage, navigationRevision]);
  const contextFor = (0, import_react6.useCallback)((selection) => buildUiContext({
    sessionId,
    pageSessionId,
    workspace,
    job,
  ...
  const publishContext = (0, import_react6.useCallback)((context) => {
    if (!context) return;
  ...
  const registerSelectionReader = (0, import_react6.useCallback)((read) => bridge.registerCurrentSelection(sessionId, pageSessionId, read), [bridge, contextScope, pageSessionId, sessionId]);
  const jobContext = (0, import_react6.useMemo)(() => contextFor({}), [contextFor]);
  const resetChildContext = (0, import_react6.useCallback)(() => {
  ...
  const artifactProfile = deriveArtifactProfile({ historical, context: artifacts.context, registry: artifacts.registry, job: activeJob });
  const profileSections = sectionsForArtifactProfile(artifactProfile, { historical });
  const primarySections = profileSections.primary;
  const advancedSections = profileSections.advanced;
  const pipelineStages = pipelineStagesForArtifactProfile(artifactProfile);
  (0, import_react6.useEffect)(() => {
    if (![...primarySections, ...advancedSections].includes(section)) openSection("summary");
  }, [artifactProfile, section]);
  let content;
  if (section === "summary") content = /* @__PURE__ */ import_react6.default.createElement(JobSummaryPanel, { detail, summary: activeJob, contextFor, setContext: publishContext, askContext, navigation, openSection, t });
  else if (section === "evaluator") content = /* @__PURE__ */ import_react6.default.createElement(GovernancePanel, { job, workspace, contextFor, setContext: publishContext, askContext, navigation, proposal: interaction.evaluatorProposal, t });
  else if (section === "artifacts") content = /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("artifacts")), /* @__PURE__ */ import_react6.default.createElement(ArtifactPreview, { detail: { preview: artifacts.registry ? { kind: "structured", format: "json", title: t("artifacts"), content: artifacts.registry } : void 0 }, t }), /* @__PURE__ */ import_react6.default.createElement(JsonSection, { title: t("artifacts"), value: artifacts.registry }));
  else if (section === "audit") content = /* @__PURE__ */ import_react6.default.createElement(JsonSection, { title: t("audit"), value: { validation: detail?.validation, context: artifacts.context, doctor: artifacts.doctor, registry: artifacts.registry } });
  else if (stage === "candidate") content = historical ? /* @__PURE__ */ import_react6.default.createElement(HistoricalTargetPanel, { detail, artifacts, t }) : /* @__PURE__ */ import_react6.default.createElement(CandidatePanel, { artifacts, t });
  else if (stage === "dataset") content = /* @__PURE__ */ import_react6.default.createElement(DatasetPanel, { job, workspace, artifacts, t });
  else if (stage === "renderer") content = /* @__PURE__ */ import_react6.default.createElement(RendererPanel, { job, workspace, active: Boolean(activeJob?.progress?.active), component, contextFor, setContext: publishContext, askContext, navigation, t });
  else if (stage === "judge") content = /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("trials"), " / ", t("evidence")), /* @__PURE__ */ import_react6.default.createElement(TrialExplorer, { job, workspace, active: Boolean(activeJob?.progress?.active), navigation, restoreView, onViewStateChange: (value2) => {
    trialViewState.current = value2;
    onViewStateChange?.({ stage, section, trialView: value2, ...compareBaselineState.current ? { compareBaseline: compareBaselineState.current } : {} });
  ...
  else if (stage === "meta") content = historical ? /* @__PURE__ */ import_react6.default.createElement(HistoricalMetaEvaluationPanel, { detail, artifacts, t }) : /* @__PURE__ */ import_react6.default.createElement(MetaEvaluationPanel, { job, workspace, t });
  else if (stage === "reporter") content = /* @__PURE__ */ import_react6.default.createElement(ReporterPanel, { job, workspace, active: Boolean(activeJob?.progress?.active), artifacts, jobKind: detail?.jobKind ?? activeJob?.jobKind, interaction: { contextFor, setContext: publishContext, askContext, navigation, restoreView, onViewStateChange: (value2) => {
    trialViewState.current = value2;
    onViewStateChange?.({ stage, section, trialView: value2 });
  } }, t });
  else if (stage === "optimizer") content = /* @__PURE__ */ import_react6.default.createElement(OptimizerPanel, { artifacts, interactionObjects: detail?.interactionObjects, contextFor, setContext: publishContext, askContext, navigation, t });
  else if (stage === "gate") content = historical ? /* @__PURE__ */ import_react6.default.createElement(HistoricalGatePanel, { t }) : /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement(ComparePanel, { job, workspace, jobs, artifacts, gate: gateIdentity, navigation, restoreView, onViewStateChange: (value2) => {
    compareBaselineState.current = value2;
    onViewStateChange?.({ stage, section, compareBaseline: value2, ...gateRouteState.current ? { gateRoute: gateRouteState.current } : {}, ...trialViewState.current ? { trialView: trialViewState.current } : {} });
  }, contextFor, setContext: publishContext, askContext, t }), /* @__PURE__ */ import_react6.default.createElement(GateEvidencePanel, { artifacts, interactionObjects: detail?.interactionObjects, contextFor, setContext: publishContext, askContext, navigation, t }));
  else content = stage === "integration" ? /* @__PURE__ */ import_react6.default.createElement(ContractPanel, { artifacts, component, t }) : /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-section" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-components" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-component" }, /* @__PURE__ */ import_react6.default.createElement("span", null, stage, component?.reward_affecting ? " \xB7 reward-affecting" : ""), /* @__PURE__ */ import_react6.default.createElement("b", null, component?.id ?? "\u2014", " \xB7 ", component?.version ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("code", null, short(component?.digest)))));
  return /* @__PURE__ */ import_react6.default.createElement("aside", { className: "hse-drawer", "aria-label": job, onClickCapture: () => consumeNavigation?.(navigation), onPointerDown: stopRestoredScroll, onWheel: stopRestoredScroll, onKeyDown: stopRestoredScroll }, /* @__PURE__ */ import_react6.default.createElement("header", { className: "hse-drawer-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h2", null, job), /* @__PURE__ */ import_react6.default.createElement("p", null, historical ? `${t("historicalTarget")} \xB7 ${target.source_kind ?? activeJob?.generationSource?.kind ?? "\u2014"} \xB7 ${target.record_count ?? activeJob?.nTrials ?? 0} ${t("generationRecords")}` : `${activeJob?.candidate?.candidate_id ?? "\u2014"} \xB7 ${activeJob?.candidate?.version ?? "\u2014"}`, " \xB7 ", activeJob?.mode ?? "\u2014", " \xB7 ", activeJob?.progress?.completed ?? 0, "/", activeJob?.progress?.total ?? 0)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-drawer-actions" }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-ask", disabled: !jobContext, onClick: () => void askContext(jobContext, t("suggestedQuestion4")) }, t("askAi")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-close", onClick: close }, hasHistory ? t("back") : t("backToJobs")))), /* @__PURE__ */ import_react6.default.createElement(JobIdentityHeader, { context: jobContext, summary: activeJob, t }), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-workbench" }, /* @__PURE__ */ import_react6.default.createElement("nav", { className: "hse-object-nav", "aria-label": t("mainIdentity") }, primarySections.map((item) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", key: item, "aria-current": section === item ? "page" : void 0, onClick: () => openSection(item) }, t(`jobSection_${item}`)))), /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-advanced-nav", open: advancedSections.includes(section) ? true : void 0 }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("advancedDetails")), /* @__PURE__ */ import_react6.default.createElement("nav", { className: "hse-object-nav" }, advancedSections.map((item) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", key: item, "aria-current": section === item ? "page" : void 0, onClick: () => openSection(item) }, t(`jobSection_${item}`))))), section === "pipeline" ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("pipelineHint")), /* @__PURE__ */ import_react6.default.createElement("nav", { className: "hse-stage-nav", "aria-label": t("stageNav") }, pipelineStages.map((item) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", key: item, "data-active": stage === item, "aria-current": stage === item ? "step" : void 0, onClick: () => setStage(item) }, pipelineStages.indexOf(item) + 1, ". ", historical && item === "candidate" ? t("historicalTarget") : historical && item === "dataset" ? t("generationRecords") : t(item))))) : null, state.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "workbench", rows: 7, label: t("loading") }) : state.status === "error" ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.error, retry: () => void load(), t }) : /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, state.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.error, title: state.stale ? t("workbenchStale") : void 0, retry: () => void load(), t }) : null, !contextSupported ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, t("capabilityUnavailable")) : null, content)));
}
function historicalError(value2) {
  const message = value2?.message ?? String(value2 ?? "");
  const code = value2?.code ?? message.match(/\b([A-Z][A-Z0-9_]{3,})\b/)?.[1] ?? "HISTORICAL_JOB_FAILED";
  return { code, message: message.replace(new RegExp(`^${code}:\\s*`), ""), observedAt: (/* @__PURE__ */ new Date()).toISOString() };
}
function HistoricalLauncher({ snapshot, reload, onCompleted, t, variant = "card", pluginVersion }) {
  const request = useHarborApi();
  const update = useHarborMutation();
  const [state, setState] = (0, import_react6.useState)({ status: "idle" });
  const [open, setOpen] = (0, import_react6.useState)(false);
  const previewSequence = (0, import_react6.useRef)(0);
  const workspaceGeneration = (0, import_react6.useRef)(0);
  ...
  const preview = async () => {
    ...
    try {
      const value2 = await update("historical-preview", {
        workspace,
        limit: 3,
        includeFeedback: true
      });
      if (sequence !== previewSequence.current) return;
      setState({ status: "ready", preview: value2 });
    } catch (error) {
      if (sequence !== previewSequence.current) return;
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, variant === "hero" ? /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-hero", style: { "--ocean-image": `url(${harbor_ocean_default})` }, "aria-live": "polite" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hero-top" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hero-copy" }, /* @__PURE__ */ import_react6.default.createElement("h1", null, "Harbor", pluginVersion ? /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-hero-version" }, "v", pluginVersion) : null), /* @__PURE__ */ import_react6.default.createElement("p", null, t("heroTitle"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hero-actions" }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-refresh", onClick: () => void reload() }, t("refresh")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-hero-primary", disabled: !workspace || state.status === "previewing", onClick: () => active ? setOpen(true) : void preview() }, buttonLabel))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hero-bottom" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hero-health" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("health")), /* @__PURE__ */ import_react6.default.createElement("b", null, snapshot ? t(healthKey) : "\u2014"), /* @__PURE__ */ import_react6.default.createElement("small", null, t("attentionCountHint"))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-stats" }, heroStats.map(([label, value2]) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-stat", key: label }, /* @__PURE__ */ import_react6.default.createElement("span", null, label), /* @__PURE__ */ import_react6.default.createElement("b", null, value2)))))) : /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-launch-card", "aria-live": "polite" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-launch-mark", "aria-hidden": "true" }, "\u2726"), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-launch-copy" }, /* @__PURE__ */ import_react6.default.createElement("b", null, active ? t("historicalRunning") : t("historicalLaunch")), /* @__PURE__ */ import_react6.default.createElement("span", null, active ? t("historicalRunningHint") : t("historicalLaunchBody")), /* @__PURE__ */ import_react6.default.createElement("small", null, active ? `${state.operation?.selectedCount ?? "\u2014"} ${t("historicalSessionUnit")}` : t("historicalLaunchHint"))), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-launch-button", disabled: !workspace || state.status === "previewing", onClick: () => active ? setOpen(true) : void preview() }, /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-launch-button-full" }, buttonLabel), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-launch-button-short" }, buttonShort))), open ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-launch-overlay", role: "presentation", onMouseDown: (event) => event.target === event.currentTarget && close() }, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-launch-dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": "hse-historical-title" }, /* @__PURE__ */ import_react6.default.createElement("header", { className: "hse-launch-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, t("historicalLaunchHint")), /* @__PURE__ */ import_react6.default.createElement("h2", { id: "hse-historical-title" }, dialogTitle), /* @__PURE__ */ import_react6.default.createElement("p", null, dialogHint)), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-dialog-close", "aria-label": t("close"), onClick: close }, "\xD7")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-launch-body" }, state.status === "previewing" ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-empty" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-spin" }), t("historicalPreparing")) : null, state.status === "starting" ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-empty" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-spin" }), t("historicalStarting")) : null, state.status === "running" ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-run-state" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-spin" }), /* @__PURE__ */ import_react6.default.createElement("b", null, t("historicalRunning")), /* @__PURE__ */ import_react6.default.createElement("span", null, state.operation?.selectedCount ?? "\u2014", " ", t("historicalSessionUnit")), /* @__PURE__ */ import_react6.default.createElement("p", null, t("historicalRunningHint"))) : null, state.status === "completed" ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-run-state" }, /* @__PURE__ */ import_react6.default.createElement("b", null, "\u2713 ", t("historicalCompleted"))) : null, state.status === "error" ? /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-launch-section" }, /* @__PURE__ */ import_react6.default.createElement("p", { role: "alert" }, historicalErrorHint(state.error.code, t)), /* @__PURE__ */ import_react6.default.createElement("details", null, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("historicalErrorDetails")), /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: { ...state.error, nextStep: historicalErrorHint(state.error.code, t) }, t }))) : null, state.status === "ready" && previewValue ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-boundary-note" }, t("historicalPrivacyHint")), previewValue.scan?.partial ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("historicalPartialHint")) : null, previewValue.excludedCounts?.unreadable > 0 ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-muted" }, t("historicalUnreadableHint")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-launch-summary" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, t("selectedSessions")), /* @__PURE__ */ import_react6.default.createElement("b", null, previewValue.selected.length)), /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("span", null, t("judgeIdentity")), /* @__PURE__ */ import_react6.default.createElement("b", null, judge?.provider ?? "\u2014", " / ", judge?.model ?? "\u2014"))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-launch-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("historicalDataPolicy")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-boundary-note" }, dataPolicy?.mode === "source-text-with-secret-redaction" && dataPolicy?.localPaths === "preserved" ? t("historicalDataPolicyValue") : dataPolicy?.mode ?? "\u2014"), /* @__PURE__ */ import_react6.default.createElement("h3", null, t("historicalJudgeBoundary")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-boundary-note" }, t("historicalJudgeBoundaryDetail"))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-launch-section" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, t("recentSessions")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-session-list" }, previewValue.selected.map((session) => /* @__PURE__ */ import_react6.default.createElement("article", { key: session.trialId }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("b", null, session.title), /* @__PURE__ */ import_react6.default.createElement("span", null, session.lastActivityAt ? new Date(session.lastActivityAt).toLocaleString() : "\u2014")), /* @__PURE__ */ import_react6.default.createElement("p", null, t("turnCounts"), " ", session.turnCount ?? 0, " \xB7 ", t("toolCounts"), " ", session.toolCallCount ?? 0))))), /* @__PURE__ */ import_react6.default.createElement("details", { className: "hse-launch-section" }, /* @__PURE__ */ import_react6.default.createElement("summary", null, t("historicalBoundaries")), /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-boundary-note" }, t("historicalBoundaryDetail")))) : null), /* @__PURE__ */ import_react6.default.createElement("footer", { className: "hse-launch-actions" }, state.status === "ready" ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: close }, t("cancel")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-confirm", onClick: () => void confirm() }, t("historicalConfirm"))) : null, state.status === "error" ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: close }, t("close")), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => void preview() }, t("previewAgain"))) : null, state.status === "running" ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: close }, t("close")) : null))) : null);
}
function DashboardView(props) {
  return /* @__PURE__ */ import_react6.default.createElement(HarborSessionContext.Provider, { value: props.sessionId }, /* @__PURE__ */ import_react6.default.createElement(DashboardSessionView, { key: String(props.sessionId), ...props }));
}
...
function DashboardSessionView({ t, bridge, sessionId, useInput, inputActions, replaceHarborReference }) {
  const [workspace, setWorkspace] = (0, import_react6.useState)("");
  const [offset, setOffset] = (0, import_react6.useState)(0);
  const [attentionFilter, setAttentionFilter] = (0, import_react6.useState)("all");
  const state = useDashboard(true, workspace, offset, sessionId, attentionFilter);
  const [selected, setSelected] = (0, import_react6.useState)();
  const [historyDepth, setHistoryDepth] = (0, import_react6.useState)(0);
  const [navigationRevision, setNavigationRevision] = (0, import_react6.useState)(0);
  const rootNode = (0, import_react6.useRef)();
  const scrollNode = (0, import_react6.useRef)();
  (0, import_react6.useEffect)(() => {
    scrollNode.current = nearestScrollPort(rootNode.current);
  }, []);
  const navigationHistory = (0, import_react6.useRef)([]);
  const activeWorkbenchView = (0, import_react6.useRef)();
  const handledNavigation = (0, import_react6.useRef)();
  const restoreSequence = (0, import_react6.useRef)(0);
  const pendingDashboardRestore = (0, import_react6.useRef)();
  const [pageSessionId] = (0, import_react6.useState)(pageSessionIdentity);
  (0, import_react6.useEffect)(() => () => bridge.clearCurrent(sessionId, pageSessionId), [bridge, pageSessionId, sessionId]);
  const phase = useInput((input) => input?.phase ?? "plain");
  const phaseRef = (0, import_react6.useRef)(phase);
  ...
  const askContext = (0, import_react6.useCallback)(async (context, prompt = "") => {
  ...
  const completedHistorical = (0, import_react6.useCallback)((operation) => {
    bridge.clearCurrent(sessionId, pageSessionId);
    navigationHistory.current = [];
    setHistoryDepth(0);
    activeWorkbenchView.current = void 0;
  ...
  const closeWorkbench = (0, import_react6.useCallback)(() => {
    bridge.clearCurrent(sessionId, pageSessionId);
  ...
  const consumeNavigation = (0, import_react6.useCallback)((navigation) => {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    if (recognized) {
      bridge.clearCurrent(sessionId, pageSessionId);
      setNavigationRevision((value2) => value2 + 1);
      const viewState = {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(HarborSessionContext.Provider, { value: sessionId }, /* @__PURE__ */ import_react6.default.createElement("main", { ref: rootNode, className: "hse-root" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-page hse-layout" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-main-panel" }, ui.error ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: ui.error, title: t("contextBindFailed"), t }) : null, /* @__PURE__ */ import_react6.default.createElement(OperationTray, { hideWhenEmpty: true, ...{ sessionId, request, update }, scopeKey: snapshot?.workspace?.id ?? workspace, t: (key) => t(`operationTray_${key}`), onViewResult: viewDiagnostic }), selected ? /* @__PURE__ */ import_react6.default.createElement(Workbench, { key: `${selected.workspace}\0${selected.job}`, job: selected.job, workspace: selected.workspace, jobs: snapshot?.jobs ?? [], close: closeWorkbench, navigation: selected.navigation, navigationRevision, consumeNavigation, restoreView: selected.restoreView, hasHistory: selected.fromNavigation, scrollContainerRef: scrollNode, onViewStateChange: (value2) => {
    activeWorkbenchView.current = value2;
  }, sessionId, pageSessionId, bridge, askContext, t }) : /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, historyDepth ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-button hse-dashboard-back", onClick: closeWorkbench }, t("back")) : null, /* @__PURE__ */ import_react6.default.createElement(HistoricalLauncher, { variant: "hero", snapshot, reload: state.load, onCompleted: completedHistorical, t, pluginVersion: "0.10.1" }), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-experiment-onboarding", "aria-labelledby": "hse-formal-experiment-title" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h3", { id: "hse-formal-experiment-title" }, t("formalExperiment")), /* @__PURE__ */ import_react6.default.createElement("p", null, t("formalExperimentHint")), /* @__PURE__ */ import_react6.default.createElement("code", null, t("formalExperimentFlow"))), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: !snapshot?.workspace?.id, onClick: () => void askContext(buildUiContext({ sessionId, pageSessionId, workspace: snapshot.workspace.id }), t("formalExperimentPrompt")) }, t("planFormalExperiment"))), /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-attention-filters", "aria-label": t("attention") }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-health-filters" }, ATTENTION_FILTERS.map((filter) => /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", key: filter, "aria-pressed": attentionFilter === filter, onClick: () => {
    setAttentionFilter(filter);
    setOffset(0);
  } }, /* @__PURE__ */ import_react6.default.createElement("span", null, t(`health_${filter}`)), /* @__PURE__ */ import_react6.default.createElement("b", null, snapshot?.overview?.attention?.[filter] ?? "\u2014"))))), state.stale ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-capability" }, t("dashboardStale")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-head" }, /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("h2", null, t("attention"), " \xB7 ", t(`health_${attentionFilter}`)), /* @__PURE__ */ import_react6.default.createElement("p", null, t("jobsHint"))), snapshot?.workspaces?.length ? /* @__PURE__ */ import_react6.default.createElement("select", { className: "hse-select", "aria-label": t("workspaceSelect"), value: snapshot.workspace?.id ?? "", onChange: switchWorkspace }, snapshot.workspaces.map((item) => /* @__PURE__ */ import_react6.default.createElement("option", { value: item.id, key: item.id }, item.label, " \xB7 ", item.root))) : null), snapshot?.workspace ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-hook-state" }, /* @__PURE__ */ import_react6.default.createElement("b", null, t("workspace"), ": ", snapshot.workspace.label)) : null, state.status === "loading" ? /* @__PURE__ */ import_react6.default.createElement(HarborSkeleton, { kind: "dashboard", rows: 7, label: t("loading") }) : state.status === "error" && !snapshot ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.errorDetails ?? state.error, retry: () => void state.load(), t }) : !snapshot?.jobs?.length ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-empty" }, t(attentionFilter === "all" ? "empty" : "noFilteredJobs"), attentionFilter !== "all" ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-button", onClick: () => {
    setAttentionFilter("all");
    setOffset(0);
  } }, t("clearFilters")) : null) : /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-list" }, snapshot.jobs.map((job) => /* @__PURE__ */ import_react6.default.createElement(JobCard, { job, t, open: openJob, ask: askJob, key: job.name }))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-pager" }, /* @__PURE__ */ import_react6.default.createElement("span", null, pagination.total ? `${offset + 1}\u2013${Math.min(offset + (snapshot.jobs?.length ?? 0), pagination.total)} / ${pagination.total}` : "0 / 0"), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !offset, onClick: () => setOffset(Math.max(0, offset - (pagination.limit ?? 20))) }, t("previous")), /* @__PURE__ */ import_react6.default.createElement("button", { disabled: !pagination.hasMore, onClick: () => setOffset(offset + (pagination.limit ?? 20)) }, t("next")))))))));
}
function VersionPanel({ t }) {
  const state = useVersionCheck();
  const [copied, setCopied] = (0, import_react6.useState)(false);
  const value2 = state.value;
  const status = state.status === "loading" ? "loading" : state.status === "error" ? "unavailable" : value2?.status ?? "unavailable";
  ...
  const copy2 = async () => {
    if (!value2?.command) return;
    try {
      await navigator.clipboard.writeText(value2.command);
      setCopied(true);
      window.setTimeout(() => setCopied(false), 1500);
    } catch {
      setCopied(false);
  ...
  return /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-version", "data-status": status, "aria-live": "polite" }, /* @__PURE__ */ import_react6.default.createElement("header", { className: "hse-version-head" }, /* @__PURE__ */ import_react6.default.createElement("h3", null, "\u{1F433} ", t("pluginVersion")), /* @__PURE__ */ import_react6.default.createElement("span", { className: "hse-version-badge" }, statusLabel)), value2 ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-version-grid" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-version-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("currentVersion")), /* @__PURE__ */ import_react6.default.createElement("b", null, value2.currentVersion)), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-version-card" }, /* @__PURE__ */ import_react6.default.createElement("span", null, t("latestVersion")), /* @__PURE__ */ import_react6.default.createElement("b", null, value2.latestVersion ?? "\u2014"))) : null, status === "update-available" ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-version-copy" }, value2?.command ? t("updateHint") : t("offlineUpdateHint")) : null, value2?.command ? /* @__PURE__ */ import_react6.default.createElement("code", { className: "hse-update-command" }, value2.command) : null, status === "unavailable" ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-version-copy" }, t("offlineUpdateHint")) : null, value2?.stale ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-version-copy" }, t("staleVersion")) : null, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-version-actions" }, value2?.command ? /* @__PURE__ */ import_react6.default.createElement("button", { className: "hse-primary", type: "button", onClick: () => void copy2() }, copied ? t("updateCommandCopied") : t("copyUpdateCommand")) : null, value2?.releaseUrl ? /* @__PURE__ */ import_react6.default.createElement("a", { href: value2.releaseUrl, target: "_blank", rel: "noreferrer" }, t("viewRelease")) : null, status !== "loading" ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => void state.load(true) }, t("checkAgain")) : null, value2?.checkedAt ? /* @__PURE__ */ import_react6.default.createElement("small", null, t("checkedAt"), ": ", new Date(value2.checkedAt).toLocaleString()) : null));
}
function DoctorView({ t }) {
  const state = useDashboard(false);
  const [projectRoot, setProjectRoot] = (0, import_react6.useState)("");
  const [mutation, setMutation] = (0, import_react6.useState)({ status: "idle" });
  (0, import_react6.useEffect)(() => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("main", { className: "hse-root" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-settings" }, /* @__PURE__ */ import_react6.default.createElement("h2", null, t("setupDoctor")), /* @__PURE__ */ import_react6.default.createElement("p", null, t("setupHint")), state.errorDetails ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: state.errorDetails, title: state.stale ? t("dashboardStale") : void 0, retry: () => void state.load(), t }) : null, /* @__PURE__ */ import_react6.default.createElement(VersionPanel, { t }), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-root-switch" }, /* @__PURE__ */ import_react6.default.createElement("label", { htmlFor: "hse-project-root" }, t("projectRoot")), /* @__PURE__ */ import_react6.default.createElement("input", { id: "hse-project-root", value: projectRoot, onChange: (event) => setProjectRoot(event.target.value), spellCheck: false }), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", disabled: mutation.status === "saving" || !projectRoot, onClick: () => void switchRoot() }, mutation.status === "saving" ? t("switchingProjectRoot") : t("switchProjectRoot")), /* @__PURE__ */ import_react6.default.createElement("small", null, mutation.status === "saved" ? t("projectRootUpdated") : t("projectRootHint")), /* @__PURE__ */ import_react6.default.createElement("small", null, rootSource), mutation.status === "error" ? /* @__PURE__ */ import_react6.default.createElement(HarborErrorState, { error: mutation.error, retry: () => void switchRoot(), t }) : null), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-checks" }, Object.entries(state.value?.checks ?? {}).map(([key, check]) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-check", key }, /* @__PURE__ */ import_react6.default.createElement("b", { className: check.status === "ok" ? "hse-valid" : "hse-invalid" }, key, " \xB7 ", check.status), /* @__PURE__ */ import_react6.default.createElement("small", null, check.detail)))), /* @__PURE__ */ import_react6.default.createElement("h3", null, t("credentialPolicy")), /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-checks" }, credentialTiers.map(([label, status, hint, active]) => /* @__PURE__ */ import_react6.default.createElement("div", { className: "hse-check", key: label }, /* @__PURE__ */ import_react6.default.createElement("b", { className: active ? "hse-valid" : "hse-invalid" }, label, " \xB7 ", status), /* @__PURE__ */ import_react6.default.createElement("small", null, hint))))));
}
...
function decodeToolResult(block) {
  ...
  try {
    const value2 = JSON.parse(blockText(block));
    return isRecord(value2) ? value2 : void 0;
  } catch {
    return void 0;
  }
...
function HarborToolView({ block, toolName, bridge, sessionId, prepareQuestion, t }) {
  const [open, setOpen] = (0, import_react6.useState)(false);
  const [navigationNotice, setNavigationNotice] = (0, import_react6.useState)("");
  const settled = block?.kind === "tool-result";
  const value2 = settled ? decodeToolResult(block) : void 0;
  const uiAction = trustedHarborUiAction(toolName, value2);
  const draft = toolName === "harbor_propose_action" && value2?.schema === "harbor-action-draft/v1" && typeof value2.draftId === "string" && value2.draftId ? value2 : void 0;
  ...
  return /* @__PURE__ */ import_react6.default.createElement(HarborSessionContext.Provider, { value: sessionId }, /* @__PURE__ */ import_react6.default.createElement("section", { className: "hse-tool" }, /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", onClick: () => setOpen(!open) }, /* @__PURE__ */ import_react6.default.createElement("strong", null, "\u{1F433} ", toolName), /* @__PURE__ */ import_react6.default.createElement("small", null, !settled ? "running" : block.isError ? "error" : "\u2713")), open ? /* @__PURE__ */ import_react6.default.createElement("pre", null, value2 ? pretty2(value2) : blockText(block) || "Running\u2026") : null, uiAction ? /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "hse-tool-action", onClick: () => onNavigate(bridge.navigate(sessionId, uiAction, { force: true })) }, t("viewInHarbor")) : null, draft ? /* @__PURE__ */ import_react6.default.createElement(ActionDraftCard, { draft, onSourceDraft: actions.openSourceDraft, onReprepare: actions.reprepare, onViewComparison: actions.viewComparison, onViewResult: (result) => actions.viewDiagnostic(draft, result), t }) : null, navigationNotice ? /* @__PURE__ */ import_react6.default.createElement("p", { className: "hse-draft-notice", role: "status" }, navigationNotice) : null));
}
