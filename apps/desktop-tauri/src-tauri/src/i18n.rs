...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusMatchingHome => "正在准备 YourHarness 独立工作台…",
        ...
        Msg::StatusProductRuntime => "正在加载 YourHarness 的 Harbor 插件与 Skill…",
        ...
        Msg::StatusHomeNone => "已启用 YourHarness 独立主目录",
        ...
        Msg::NotifyBody => "YourHarness 已完成本轮任务",
...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusMatchingHome => "Preparing YourHarness's isolated workbench…",
        ...
        Msg::StatusProductRuntime => "Loading YourHarness's Harbor plugin and Skill…",
        ...
        Msg::StatusHomeNone => "Using YourHarness's isolated home",
        ...
        Msg::NotifyBody => "YourHarness finished this turn",
