...
The desktop targets macOS Apple Silicon. YourBuddy 0.3.15 is the current verified public release: complete-file integrity, the updater signature, App identity, bundled creator-publishing resources, product source records, and the relocated runtime passed independent checks. Native startup and packaged-WebView interaction remain unverified.
