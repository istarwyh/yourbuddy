...
提供一个经过选择的起点，同时保留各项目的贡献与归属。

| 插件 | 默认集成的理由 |
|---|---|
| [Codex Auth](codex-auth.zh.md) | 将已有账号连接到模型、搜索与图片能力 |
| [Better Sidebar](better-sidebar.zh.md) | 检查文件、命令、差异与后台任务 |
...
YourBuddy 自有 Personal Workbench 提供[品牌、网络、更新与重启设置](../settings.zh.md)。仓库内 Codex Subagent 提供[明确任务委派](../workspace.zh.md)，与 Codex Auth 的主模型接入不同。Harbor Skill 与 Python Adapter 是配套组成，无需当作额外产品重复安装。
