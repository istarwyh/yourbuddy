...
|---|---|---|---|---|
| [yourbuddy-v0.3.10](yourbuddy-v0.3.10/README.zh.md) | YourBuddy 桌面应用 | 已包含 | 部分完成；已记录源码、CI、公开文件、Updater 签名、App 标识、产品 Provenance 与迁移运行时，官网与可下载归档待完成 | 已发布并在声明范围内完成独立核验 |
