...
|---|---|---|---|---|
| [yourbuddy-v0.3.7](yourbuddy-v0.3.7/README.zh.md) | YourBuddy 桌面应用 | 已包含 | 已记录源码、CI、截图、公开文件、Updater 签名、App 标识、provenance 补丁、迁移运行时与原生启动跳过；官网和可下载归档待完成 | 已发布并在声明范围内完成独立核验 |
