...
|---|---|---|---|---|
| [yourbuddy-v0.3.14](yourbuddy-v0.3.14/README.md) | YourBuddy desktop | Included | Partial; creator publishing source, bundled Skill, dry-run, deterministic snapshot-mode hashing, and product assembly evidence recorded; release artifacts and downloadable archive remain pending | Release candidate in preparation |
| [yourbuddy-v0.3.13](yourbuddy-v0.3.13/README.md) | YourBuddy desktop | Included | Pre-publication checks and failed workflow evidence retained | Failed before artifact publication; superseded by 0.3.14 |
...
| [yourbuddy-v0.3.11](yourbuddy-v0.3.11/README.md) | YourBuddy desktop | Included | Complete; records source, CI, public files, updater signature, App identity, Oil Creator provenance, relocated runtime, website, downloadable archive, and retained native-startup, packaged-WebView, OAuth, optional-integration, and real-model limits | Published and independently verified within the stated scope |
...
| [yourbuddy-v0.3.7](yourbuddy-v0.3.7/README.md) | YourBuddy desktop | Included | Complete; source, CI, screenshot, public files, updater signature, App identity, provenance patches, relocated runtime, website, downloadable archive, and native-startup skip recorded | Published and independently verified within stated limits |
| [yourbuddy-v0.3.6](yourbuddy-v0.3.6/README.md) | YourBuddy desktop | Included | Complete; source, CI, public files, updater signature, App identity, relocated runtime, website, downloadable archive, and native-startup skip recorded; retained product limits remain explicit | Published and independently verified within stated limits |
| [yourbuddy-v0.3.5](yourbuddy-v0.3.5/README.md) | YourBuddy desktop | Included | Complete; source, CI, public files, updater signature, App identity, relocated runtime, website, downloadable archive, and native-startup skip recorded; installed WebView and real OAuth limits retained | Published and independently verified within stated limits |
| [yourbuddy-v0.3.4](yourbuddy-v0.3.4/README.md) | YourBuddy desktop | Included | Complete; seven historical source images, public artifacts, updater signature, relocated runtime, isolated startup, website, and downloadable archive recorded; visual-window limits retained | Published and independently verified within stated limits |
