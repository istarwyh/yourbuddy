...
|---|---|---|---|---|
| [yourbuddy-v0.3.17](yourbuddy-v0.3.17/README.md) | YourBuddy desktop | Included | Pre-publication archive; source, native startup, public artifacts, updater, website, and downloadable evidence pending | Candidate; not yet published |
