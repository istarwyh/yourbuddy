...
|---|---|---|---|---|
| [yourbuddy-v0.3.9](yourbuddy-v0.3.9/README.md) | YourBuddy desktop | Included | In progress; source, screenshot, CI, public files, updater signature, App identity, relocated runtime, and website recorded; downloadable archive pending | Published and independently verified within the recorded product scope |
