...
|---|---|---|---|---|
| [yourbuddy-v0.3.9](yourbuddy-v0.3.9/README.md) | YourBuddy desktop | Included | In progress; source, screenshot, CI, public files, updater signature, App identity, and relocated runtime recorded; website and downloadable archive pending | Published and independently verified within the recorded product scope |
