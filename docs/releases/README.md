...
|---|---|---|---|---|
| [yourbuddy-v0.3.6](yourbuddy-v0.3.6/README.md) | YourBuddy desktop | Included | Product evidence complete within stated scope; source, CI, public files, updater signature, App identity, relocated runtime, and native-startup skip recorded; website and download archive pending | Published and independently verified within stated limits |
