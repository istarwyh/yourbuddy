...
|---|---|---|---|---|
| [yourbuddy-v0.3.10](yourbuddy-v0.3.10/README.md) | YourBuddy desktop | Included | Partial; source, CI, public files, updater signature, App identity, product provenance, relocated runtime, and website recorded, with downloadable archive pending | Published and independently verified within stated limits |
