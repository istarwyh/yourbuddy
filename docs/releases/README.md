...
|---|---|---|---|---|
| [yourbuddy-v0.3.10](yourbuddy-v0.3.10/README.md) | YourBuddy desktop | Included | Partial; source, CI, public files, updater signature, App identity, product provenance, and relocated runtime recorded, with website and downloadable archive pending | Published and independently verified within stated limits |
