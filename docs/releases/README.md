...
|---|---|---|---|---|
| [yourbuddy-v0.3.12](yourbuddy-v0.3.12/README.md) | YourBuddy desktop | Included | Draft; Harbor 0.9.8 root cause and source/public-package regression recorded; release artifacts, fresh packaged Historical Job, website, and downloadable archive remain pending | Release candidate in preparation |
