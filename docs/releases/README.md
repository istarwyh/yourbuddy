...
|---|---|---|---|---|
| [yourbuddy-v0.3.13](yourbuddy-v0.3.13/README.md) | YourBuddy desktop | Included | Partial; creator publishing source, bundled Skill, dry-run, and product assembly evidence recorded; release artifacts, website, and downloadable archive remain pending | Release candidate in preparation |
