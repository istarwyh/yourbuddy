...
|---|---|---|---|---|
| [yourbuddy-v0.3.6](yourbuddy-v0.3.6/README.md) | YourBuddy desktop | Included | Product and website evidence complete within stated scope; source, CI, public files, updater signature, App identity, relocated runtime, website, and native-startup skip recorded; download archive pending | Published and independently verified within stated limits |
