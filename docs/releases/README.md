...
|---|---|---|---|---|
| [yourbuddy-v0.3.15](yourbuddy-v0.3.15/README.md) | YourBuddy desktop | Included | Partial; creator publishing source, generated runtime modules, bundled Skill, dry-run, deterministic snapshot hashing, and product assembly evidence recorded; release artifacts and downloadable archive remain pending | Release candidate in preparation |
