...
|---|---|---|---|---|
| [yourbuddy-v0.3.6](yourbuddy-v0.3.6/README.md) | YourBuddy desktop | Included | Partial candidate record; source, local private-CA path, complete assembly, and pull-request CI recorded; public files, updater, App, website, and download archive pending | Awaiting tag and product publication |
