...
|---|---|---|---|---|
| [yourbuddy-v0.3.1](yourbuddy-v0.3.1/README.md) | YourBuddy desktop | Included | Public artifact evidence complete; immutable link and download pending | Published and independently verified |
