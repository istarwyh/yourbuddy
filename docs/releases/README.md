...
|---|---|---|---|---|
| [yourbuddy-v0.3.7](yourbuddy-v0.3.7/README.md) | YourBuddy desktop | Included | Local source, assembled-client screenshot, compatibility replay, and release-candidate evidence included; public evidence is added after publication | Release candidate |
