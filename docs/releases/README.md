...
|---|---|---|---|---|
| [yourbuddy-v0.3.10](yourbuddy-v0.3.10/README.md) | YourBuddy desktop | Included | Partial; local source and assembled-product evidence recorded, with public files, updater metadata, website, and downloadable archive pending | Pre-publication candidate |
