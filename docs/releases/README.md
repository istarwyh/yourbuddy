...
|---|---|---|---|---|
| [yourbuddy-v0.3.7](yourbuddy-v0.3.7/README.md) | YourBuddy desktop | Included | Source, CI, screenshot, public files, updater signature, App identity, provenance patches, relocated runtime, and native-startup skip recorded; website and downloadable archive pending | Published and independently verified within stated limits |
