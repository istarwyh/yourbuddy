...
|---|---|---|---|---|
| [yourbuddy-v0.3.17](yourbuddy-v0.3.17/README.md) | YourBuddy desktop | Included | Partial; source, CI, public files, updater signature, App identity, product sources, and relocated runtime recorded; native startup, website, and downloadable archive pending | Published and independently verified within stated limits |
...
| [yourbuddy-v0.3.7](yourbuddy-v0.3.7/README.md) | YourBuddy desktop | Included | Complete; source, CI, screenshot, public files, updater signature, App identity, source-record patches, relocated runtime, website, downloadable archive, and native-startup skip recorded | Published and independently verified within stated limits |
