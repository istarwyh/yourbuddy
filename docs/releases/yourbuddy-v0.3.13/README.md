...
- Evidence commit: `2b656363d1d180cd3ca9edd21997c7d125e19429`; tagged product commit pending.
...
| Public desktop artifacts and updater | not verified | unpublished 0.3.13 candidate | GitHub Release and stable updater channel | pending publication |
| Product website | not verified | unpublished 0.3.13 candidate | English and Chinese routes | pending publication and deployment |

## Scenario: Oil Creator and bundled publishers

- Status: `passed`.
- Date and time: 2026-09-23 UTC+08:00 CST.
- Release and commit: `yourbuddy-v0.3.13`; implementation evidence commit `2b656363d1d180cd3ca9edd21997c7d125e19429`; tagged product commit pending.
