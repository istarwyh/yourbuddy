...
import type {
  ArbitrateKey, ArbitrateOutcome, ComposerKeyboard as BaseComposerKeyboard,
  Occurrence, ReferenceInsert, TokenSpan,
} from './draft-editor.ts'

export type { ArbitrateKey, ArbitrateOutcome, Occurrence, ReferenceInsert, TokenSpan } from './draft-editor.ts'
...
/** Composer keyboard operations extended with independent failed-send recovery. */
export interface ComposerKeyboard extends BaseComposerKeyboard {
  ...
  /** Discard one retained failed message and release only its attachments. */
