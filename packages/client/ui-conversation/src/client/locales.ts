...
export const zh = {
  ...
  'input.failedImages': '{count} 张图片已保留',
  'input.failedRestore': '恢复到输入框',
  'input.failedDiscard': '丢弃',
  'input.failedOccupied': '先发送或移走当前草稿，再恢复这条消息。图片会随各自消息保留。',
...
export const en = {
  ...
  'input.failedImages': '{count} images retained',
  'input.failedRestore': 'Restore to composer',
  'input.failedDiscard': 'Discard',
  'input.failedOccupied': 'Send or move the current draft before restoring this message. Images stay with their own message.',
