...
export const zh = {
  ...
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.failedMessages': '未发送消息',
  'input.failedMessage': '未发送',
  'input.failedImages': '{count} 个附件已保留',
  'input.failedRestore': '恢复到输入框',
  'input.failedDiscard': '丢弃',
  'input.failedOccupied': '先发送或移走当前草稿，再恢复这条消息。附件会随各自消息保留。',
  'input.failedRecoveryHint': '恢复不会发送。再次发送时，将读取当时打开的页面。',
  'input.failedRestored': '消息已恢复，尚未发送。再次发送时，将读取当时打开的页面。',
  ...
  'context.timeout': '页面上下文读取超时，消息尚未发送。请重试。',
  'context.cancelled': '页面上下文读取已取消，消息尚未发送。请重试。',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
...
export const en = {
  ...
  'input.failedMessages': 'Unsent messages',
  'input.failedMessage': 'Not sent',
  'input.failedImages': '{count} attachments retained',
  'input.failedRestore': 'Restore to composer',
  'input.failedDiscard': 'Discard',
  'input.failedOccupied': 'Send or move the current draft before restoring this message. Attachments stay with their own message.',
  'input.failedRecoveryHint': 'Restoring does not send. Sending again captures the page open at that time.',
  'input.failedRestored': 'Message restored, not sent. Sending again captures the page open at that time.',
  ...
  'context.timeout': 'Page context timed out. Your message was not sent; please retry.',
  'context.cancelled': 'Page context preparation was cancelled. Your message was not sent; please retry.',
