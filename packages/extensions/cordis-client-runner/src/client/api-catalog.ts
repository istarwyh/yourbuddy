...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  {
    key: 'layout',
    summary: 'Panel navigation, geometry, and optional workbench actions exposed through ctx.layout.',
    description: 'Panel navigation, geometry, and optional workbench actions exposed through ctx.layout.',
    methods: [
      {
