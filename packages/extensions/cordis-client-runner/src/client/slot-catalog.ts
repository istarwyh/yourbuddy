...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Replaceable blank-session badge, including an occupant that renders nothing.',
    doc: 'Replaceable blank-session badge, including an occupant that renders nothing.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Replaceable blank-session headline text.',
    doc: 'Replaceable blank-session headline text.',
    registerOptions: [],
    ownerProps: [
      '/** Presentation props supplied to replaceable blank-session text. */\nexport interface HeroBrandTextOwnerProps {\n  /** Host class preserving the headline or badge presentation. */\n  className?: string | undefined\n}',
    ],
